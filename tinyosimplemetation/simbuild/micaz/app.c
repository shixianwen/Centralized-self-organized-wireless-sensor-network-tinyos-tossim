...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x40395a98, const void *arg_0x40395c30);
#line 776
__extension__ 
#line 793
__extension__ 
...
#line 22
typedef nx_struct radio_type_msg {
  nx_uint8_t messagetype;
  nx_uint8_t node_level;
} __attribute__((packed)) radio_type_msg_t;
...
struct relayinginfo {
  ...
  struct relayinginfo *prev;
  struct relayinginfo *next;
};
...
enum labAppC$__nesc_unnamed4339 {
  labAppC$BEACON_MSG = 10, labAppC$QUALITY_MSG = 11, labAppC$RELAY_MSG = 12, labAppC$TEST_MSG = 13
};
typedef message_t labC$MessageRecievePool$t;
typedef TMilli labC$RadioTimer$precision_tag;
typedef TMilli labC$DelayTimer$precision_tag;
typedef message_forward_t *labC$SendQueue$t;
typedef TMilli labC$Quality_send_retransmit_csma$precision_tag;
typedef TMilli labC$FowarderTimer$precision_tag;
typedef message_forward_t labC$MessageSendPool$t;
typedef TMilli labC$QualityTimer$precision_tag;
typedef TMilli labC$Quality_forward_retransmit_csma$precision_tag;
...
typedef message_forward_t /*labAppC.MessageSendPool*/PoolC$0$pool_t;
typedef /*labAppC.MessageSendPool*/PoolC$0$pool_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t;
typedef /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$t;
typedef message_t /*labAppC.MessageRecievePool*/PoolC$1$pool_t;
typedef /*labAppC.MessageRecievePool*/PoolC$1$pool_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t;
typedef /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$t;
typedef message_forward_t */*labAppC.SendQueue*/QueueC$0$queue_t;
typedef /*labAppC.SendQueue*/QueueC$0$queue_t /*labAppC.SendQueue*/QueueC$0$Queue$t;
typedef TMilli TDMAC$Timer$precision_tag;
typedef TMilli SimpleTimeC$Timer0$precision_tag;
typedef TMilli EASAPC$RandTimer$precision_tag;
...
message_t * amsg);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void labC$finaltestMymessageSend$runTask(void );
#line 75
static void labC$sendtest_relay_Task$runTask(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void labC$AMControl$startDone(error_t error);
#line 138
static void labC$AMControl$stopDone(error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$RadioTimer$fired(void );
# 78 "LinkEstimator.nc"
static void labC$LinkEstimator$evicted(am_addr_t neighbor);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$DelayTimer$fired(void );
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void labC$Boot$booted(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void labC$TDMAControl$startDone(error_t error);
#line 138
static void labC$TDMAControl$stopDone(error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void labC$sendQualityTask$runTask(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void labC$SerialSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 138 "TDMA.nc"
static void labC$TDMA$sigNewSlot(tSlot slot);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void labC$FinalTestSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
#line 110
static void labC$BeaconSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void labC$FowardQualityTask$runTask(void );
#line 75
static void labC$sendBeaconTask$runTask(void );
#line 75
static void labC$radioSendTask$runTask(void );
#line 75
static void labC$ownSlotHandler$runTask(void );
# 167 "EASAP.nc"
static void labC$EASAP$frameseted(tFrame newframe);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void labC$RelaySend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void labC$startDelayTimer$runTask(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void labC$Control$startDone(error_t error);
#line 138
static void labC$Control$stopDone(error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$Quality_send_retransmit_csma$fired(void );
#line 83
static void labC$FowarderTimer$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 155 "SimpleTime.nc"
static void labC$SimpleTime$sigtdmatimecoming(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$QualityTimer$fired(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void labC$QualitySend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$Quality_forward_retransmit_csma$fired(void );
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
uint8_t len);
# 86 "LinkEstimator.nc"
static uint8_t LinkEstimatorP$LinkEstimator$Gettimes(message_t *msg, uint8_t len);
#line 83
static uint8_t LinkEstimatorP$LinkEstimator$Loadestimation(message_t *msg, uint8_t len);
#line 55
static uint16_t LinkEstimatorP$LinkEstimator$getForwardQuality(uint16_t neighbor);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 96
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(
#line 96
message_t * msg, 
...
static 
#line 94
/*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$t * 


/*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$get(void );
#line 80
static uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$maxSize(void );
...
static error_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$put(
#line 85
/*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$t * newVal);
#line 72
static uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$size(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Init$init(void );
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
static 
#line 94
/*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$t * 


/*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$get(void );
#line 89
static error_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$put(
#line 85
/*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$t * newVal);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Init$init(void );
# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
static 
#line 71
/*labAppC.SendQueue*/QueueC$0$Queue$t  

/*labAppC.SendQueue*/QueueC$0$Queue$head(void );
#line 90
static error_t /*labAppC.SendQueue*/QueueC$0$Queue$enqueue(
#line 86
/*labAppC.SendQueue*/QueueC$0$Queue$t  newVal);
#line 65
static uint8_t /*labAppC.SendQueue*/QueueC$0$Queue$maxSize(void );
#line 81
static 
#line 79
/*labAppC.SendQueue*/QueueC$0$Queue$t  

/*labAppC.SendQueue*/QueueC$0$Queue$dequeue(void );
#line 50
static bool /*labAppC.SendQueue*/QueueC$0$Queue$empty(void );
...
static uint8_t /*labAppC.SendQueue*/QueueC$0$Queue$size(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(
#line 96
message_t * msg, 
...
error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void TDMAC$Boot$booted(void );
# 99 "TDMA.nc"
static error_t TDMAC$TDMA$setFrame(tFrame newFrame);
#line 89
static uint16_t TDMAC$TDMA$getInterval(void );
#line 63
static error_t TDMAC$TDMA$start(tSlot sSlot, tFrame sFrame, uint16_t sInterval);
# 155 "SimpleTime.nc"
static void TDMAC$SimpleTime$sigtdmatimecoming(void );
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TDMAC$Timer$fired(void );
#line 83
static void SimpleTimeC$Timer0$fired(void );
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void SimpleTimeC$Boot$booted(void );
# 151 "SimpleTime.nc"
static tos_time_t SimpleTimeC$SimpleTime$get(void );
#line 58
static tos_time_t SimpleTimeC$SimpleTime$addUint32(tos_time_t a, uint32_t x);
#line 154
static void SimpleTimeC$SimpleTime$set_tdmastarttime(tos_time_t t);
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
static error_t LedsP$Init$init(void );
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void EASAPC$Boot$booted(void );
# 58 "EASAP.nc"
static struct Node *EASAPC$EASAP$getINF(void );
#line 201
static void EASAPC$EASAP$setFrame(uint16_t frame);
#line 95
static bool EASAPC$EASAP$isOwnSlot(tSlot slot);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void EASAPC$RandTimer$fired(void );
# 107 "EASAPImp.nc"
static struct Slot *EASAPC$EASAPImp$findSlot(tSlot slot, struct Node *pNode);
#line 89
static bool EASAPC$EASAPImp$removeSlot(tSlot slot, struct Node *pNode);
#line 66
static bool EASAPC$EASAPImp$addSlot(tSlot slot, struct Node *pNode);
# 155 "SimpleTime.nc"
static void EASAPC$SimpleTime$sigtdmatimecoming(void );
# 62 "/opt/tinyos-2.1.2/tos/interfaces/Init.nc"
...
enum SimSchedulerBasicP$__nesc_unnamed4341 {
  ...
  SimSchedulerBasicP$NUM_TASKS = 18U, 
...
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t labC$finaltestMymessageSend$postTask(void );
#line 67
static error_t labC$sendtest_relay_Task$postTask(void );
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
static 
#line 94
labC$MessageRecievePool$t * 


labC$MessageRecievePool$get(void );
#line 89
static error_t labC$MessageRecievePool$put(
#line 85
labC$MessageRecievePool$t * newVal);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t labC$AMControl$start(void );
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$RadioTimer$startOneShot(uint32_t dt);
# 86 "LinkEstimator.nc"
static uint8_t labC$LinkEstimator$Gettimes(message_t *msg, uint8_t len);
#line 83
static uint8_t labC$LinkEstimator$Loadestimation(message_t *msg, uint8_t len);
#line 55
static uint16_t labC$LinkEstimator$getForwardQuality(uint16_t neighbor);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$DelayTimer$startOneShot(uint32_t dt);
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static uint8_t labC$Packet$payloadLength(
#line 74
message_t * msg);
#line 126
static 
...
uint8_t len);
#line 106
static uint8_t labC$Packet$maxPayloadLength(void );
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
static uint16_t labC$Random$rand16(void );
# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
static 
#line 71
labC$SendQueue$t  

labC$SendQueue$head(void );
#line 90
static error_t labC$SendQueue$enqueue(
#line 86
labC$SendQueue$t  newVal);
#line 81
static 
#line 79
labC$SendQueue$t  

labC$SendQueue$dequeue(void );
#line 50
static bool labC$SendQueue$empty(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t labC$TDMAControl$start(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t labC$sendQualityTask$postTask(void );
# 99 "TDMA.nc"
static error_t labC$TDMA$setFrame(tFrame newFrame);
#line 89
static uint16_t labC$TDMA$getInterval(void );
#line 63
static error_t labC$TDMA$start(tSlot sSlot, tFrame sFrame, uint16_t sInterval);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t labC$FinalTestSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 80
static error_t labC$BeaconSend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
#line 123
static uint8_t labC$BeaconSend$maxPayloadLength(void );
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t labC$FowardQualityTask$postTask(void );
#line 67
static error_t labC$sendBeaconTask$postTask(void );
#line 67
static error_t labC$radioSendTask$postTask(void );
#line 67
static error_t labC$ownSlotHandler$postTask(void );
# 58 "EASAP.nc"
static struct Node *labC$EASAP$getINF(void );
#line 201
static void labC$EASAP$setFrame(uint16_t frame);
#line 95
static bool labC$EASAP$isOwnSlot(tSlot slot);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t labC$RelaySend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t labC$startDelayTimer$postTask(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t labC$Control$start(void );
# 59 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
static error_t labC$PacketAcknowledgements$requestAck(
#line 53
message_t * msg);
#line 85
static bool labC$PacketAcknowledgements$wasAcked(
#line 80
message_t * msg);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$Quality_send_retransmit_csma$startOneShot(uint32_t dt);
#line 73
static void labC$FowarderTimer$startOneShot(uint32_t dt);
# 89 "EASAPImp.nc"
static bool labC$EASAPImp$removeSlot(tSlot slot, struct Node *pNode);
#line 66
static bool labC$EASAPImp$addSlot(tSlot slot, struct Node *pNode);
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
static 
#line 94
labC$MessageSendPool$t * 


labC$MessageSendPool$get(void );
#line 80
static uint8_t labC$MessageSendPool$maxSize(void );
...
static error_t labC$MessageSendPool$put(
#line 85
labC$MessageSendPool$t * newVal);
#line 72
static uint8_t labC$MessageSendPool$size(void );
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t labC$AMPacket$source(
#line 84
message_t * amsg);
# 151 "SimpleTime.nc"
static tos_time_t labC$SimpleTime$get(void );


static void labC$SimpleTime$set_tdmastarttime(tos_time_t t);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$QualityTimer$startOneShot(uint32_t dt);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t labC$QualitySend$send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void labC$Quality_forward_retransmit_csma$startOneShot(uint32_t dt);
# 225 "labC.nc"
enum labC$__nesc_unnamed4348 {
#line 225
  labC$finaltestMymessageSend = 6U
};
#line 225
typedef int labC$__nesc_sillytask_finaltestMymessageSend[labC$finaltestMymessageSend];
#line 261
enum labC$__nesc_unnamed4349 {
#line 261
  labC$sendtest_relay_Task = 7U
};
#line 261
typedef int labC$__nesc_sillytask_sendtest_relay_Task[labC$sendtest_relay_Task];
#line 355
enum labC$__nesc_unnamed4350 {
#line 355
  labC$FowardQualityTask = 8U
};
#line 355
typedef int labC$__nesc_sillytask_FowardQualityTask[labC$FowardQualityTask];
#line 386
enum labC$__nesc_unnamed4351 {
#line 386
  labC$sendQualityTask = 9U
};
#line 386
typedef int labC$__nesc_sillytask_sendQualityTask[labC$sendQualityTask];
#line 575
enum labC$__nesc_unnamed4352 {
#line 575
  labC$sendBeaconTask = 10U
};
#line 575
typedef int labC$__nesc_sillytask_sendBeaconTask[labC$sendBeaconTask];
#line 799
enum labC$__nesc_unnamed4353 {
#line 799
  labC$radioSendTask = 11U
};
#line 799
typedef int labC$__nesc_sillytask_radioSendTask[labC$radioSendTask];
#line 1062
enum labC$__nesc_unnamed4354 {
#line 1062
  labC$ownSlotHandler = 12U
};
#line 1062
typedef int labC$__nesc_sillytask_ownSlotHandler[labC$ownSlotHandler];
#line 1081
enum labC$__nesc_unnamed4355 {
#line 1081
  labC$startDelayTimer = 13U
};
#line 1081
typedef int labC$__nesc_sillytask_startDelayTimer[labC$startDelayTimer];
#line 99
uint32_t labC$seq[1000];
bool labC$is_scheduled[1000];
bool labC$is_trigerred[1000];


bool labC$My_test_msg_need_retrasmit[1000];
message_t labC$radioQueueBufs1[1000][RADIO_QUEUE_LEN];
message_t * labC$radioQueue1[1000][RADIO_QUEUE_LEN];
uint8_t labC$radioIn1[1000];
#line 107
uint8_t labC$radioOut1[1000];
bool labC$radioFull1[1000];


tSlot labC$cSlot[1000];
uint8_t labC$pocet_odeslanych[1000];
uint32_t labC$remSlotsTime[1000];
uint32_t labC$maxSend[1000];
tSlot labC$rand_slot[1000];
tTime labC$cas1[1000];
tTime labC$cas2[1000];

bool labC$quality_time_start[1000];
uint32_t labC$tdmastarttime[1000];
bool labC$firstserialmessage[1000];

bool labC$starttest[1000];
bool labC$onlystartonce[1000];



message_t labC$uartQueueBufs[1000][UART_QUEUE_LEN];
message_t * labC$uartQueue[1000][UART_QUEUE_LEN];
uint8_t labC$uartIn[1000];
#line 130
uint8_t labC$uartOut[1000];
bool labC$uartBusy[1000];
#line 131
bool labC$uartFull[1000];


message_t labC$radioQueueBufs[1000][UART_RADIO_LEN];
message_t * labC$radioQueue[1000][UART_RADIO_LEN];
uint8_t labC$radioIn[1000];
#line 136
uint8_t labC$radioOut[1000];
bool labC$radioFull[1000];
bool labC$is_busy[1000];

message_t labC$testMsgBuffer[1000];
message_t labC$beaconMsgBuffer[1000];



message_t labC$qualityMsgBuffer[1000];




message_t labC$qualitysend_retransmit[1000];
message_t labC$qualityforward_retransmit[1000];
uint8_t labC$qualitysendlength[1000];
uint8_t labC$qualityforwardlength[1000];

struct relayinginfo labC$relayinfo[1000];
uint8_t labC$relayreccount[1000];

radio_type_msg_t *labC$beaconMsg[1000];
link_header_t *labC$link_header[1000];
bool labC$is_think_node[1000];

bool labC$my_levelchanged[1000];
bool labC$QualityTimer_is_from_task[1000];
bool labC$From_SendQuality_task[1000];
bool labC$From_ForwardQuality_task[1000];
bool labC$From_finaltestMymessageSend[1000];
bool labC$From_sendtest_relay_Task[1000];
bool labC$only_send_one_my_msg[1000];


uint8_t labC$times_left[1000];
uint8_t labC$my_level[1000];

route_info_t labC$route_info[1000];

message_forward_t * labC$qe[1000];



uint8_t labC$newlength[1000];
uint8_t labC$testframenumber[1000];
static inline linkest_footer_t *labC$getlinkqualityFooter(message_t * m, uint8_t len);
...
static inline void labC$print_footer_table(message_t *msg, uint8_t number_footers);
#line 212
static void labC$print_packet(message_t *msg, uint8_t len);
#line 225
static inline void labC$finaltestMymessageSend$runTask(void );
#line 261
static inline void labC$sendtest_relay_Task$runTask(void );
#line 304
static inline void labC$FinalTestSend$sendDone(message_t *msg, error_t error);
#line 355
static inline void labC$FowardQualityTask$runTask(void );
#line 386
static inline void labC$sendQualityTask$runTask(void );
#line 450
static inline void labC$Quality_send_retransmit_csma$fired(void );





static inline void labC$Quality_forward_retransmit_csma$fired(void );





static inline void labC$QualitySend$sendDone(message_t *msg, error_t error);
#line 575
static inline void labC$sendBeaconTask$runTask(void );
#line 606
static inline void labC$print_packet_into_file(message_t *msg, uint8_t len);
...
static inline void labC$print_delay_info(void );
#line 634
static inline void labC$process_relay_info(am_addr_t from, link_header_t *relayheader);
#line 669
static inline message_t *labC$QualityRecieve$receive(message_t *msg, void *payload, uint8_t len);
#line 727
static inline message_t *labC$BeaconReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 783
static am_addr_t labC$get_relay_address(am_addr_t myaddress);
#line 799
static inline void labC$radioSendTask$runTask(void );
#line 837
static inline message_t *labC$RelayReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 921
static inline void labC$RelaySend$sendDone(message_t *msg, error_t error);
#line 962
static inline message_t *labC$SerialReceive$receive(message_t *msg, void *payload, uint8_t len);
#line 998
static inline void labC$RadioTimer$fired(void );
...
static inline void labC$init(void );
#line 1044
static inline bool labC$CanSendAnotherData(void );
#line 1062
static inline void labC$ownSlotHandler$runTask(void );
#line 1081
static inline void labC$startDelayTimer$runTask(void );


static inline void labC$BeaconSend$sendDone(message_t *msg, error_t error);
...
static inline void labC$DelayTimer$fired(void );




static inline void labC$TDMA$sigNewSlot(tSlot slot);
#line 1147
static inline void labC$TDMAControl$startDone(error_t err);
#line 1171
static inline void labC$print_packet_into_seq_file(message_t *msg, uint8_t len);
...
static inline message_t *labC$FinalTestRecieve$receive(message_t *msg, void *payload, uint8_t len);
#line 1243
static inline void labC$SimpleTime$sigtdmatimecoming(void );




static inline void labC$Boot$booted(void );
#line 1268
static inline void labC$Control$startDone(error_t error);




static inline void labC$AMControl$startDone(error_t err);
...
static inline void labC$FowarderTimer$fired(void );




static inline void labC$QualityTimer$fired(void );
#line 1305
static inline void labC$LinkEstimator$evicted(am_addr_t neighbor);
static inline void labC$AMControl$stopDone(error_t err);
static inline void labC$Control$stopDone(error_t error);
static inline void labC$SerialSend$sendDone(message_t *msg, error_t error);
static inline void labC$TDMAControl$stopDone(error_t err);

static inline void labC$EASAP$frameseted(uint16_t newframe);
# 78 "LinkEstimator.nc"
...
#line 74
message_t * amsg);
# 66 "LinkEstimatorP.nc"
enum LinkEstimatorP$__nesc_unnamed4356 {
...
neighbor_table_entry_t LinkEstimatorP$NeighborTable[1000][50];
...
uint8_t LinkEstimatorP$prevSentlinkqualityIdx[1000];
...
#line 273
static inline uint8_t LinkEstimatorP$findEmptyNeighborIdx(void );
#line 287
static inline uint8_t LinkEstimatorP$findWorstNeighborIdx(uint8_t thresholdEETX);
#line 322
static inline void LinkEstimatorP$updateReverseQuality(am_addr_t neighbor, uint8_t outquality);
#line 335
static inline void LinkEstimatorP$updateEETX(neighbor_table_entry_t *ne, uint16_t newEst);
#line 365
...
#line 598
static uint16_t LinkEstimatorP$LinkEstimator$getForwardQuality(am_addr_t neighbor);
#line 714
static inline uint8_t LinkEstimatorP$LinkEstimator$Gettimes(message_t *msg, uint8_t len);
#line 739
static inline linkest_footer_t *LinkEstimatorP$getlinkqualityFooter(message_t * m, uint8_t len);
#line 752
static inline uint8_t LinkEstimatorP$LinkEstimator$Loadestimation(message_t *msg, uint8_t len);
#line 824
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 67
message_t * msg, 
...
static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 158
message_t * amsg, 
...
static inline error_t /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static error_t /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(message_t *m, error_t err);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static error_t /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(message_t *m, error_t err);
# 53 "/opt/tinyos-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[1000];
uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[1000];
/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t * /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[1000][100];
/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[1000][100];

static inline error_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Init$init(void );
#line 79
static uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$size(void );
...
static inline uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$maxSize(void );



static /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t */*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$get(void );
#line 103
static error_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$put(/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t *newVal);
#line 60
uint8_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[1000];
uint8_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[1000];
/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t * /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[1000][10];
/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[1000][10];

static inline error_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Init$init(void );
#line 88
static inline /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t */*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$get(void );
#line 103
static inline error_t /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$put(/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t *newVal);
# 48 "/opt/tinyos-2.1.2/tos/system/QueueC.nc"
/*labAppC.SendQueue*/QueueC$0$queue_t  /*labAppC.SendQueue*/QueueC$0$queue[1000][100];
uint8_t /*labAppC.SendQueue*/QueueC$0$head[1000];
uint8_t /*labAppC.SendQueue*/QueueC$0$tail[1000];
uint8_t /*labAppC.SendQueue*/QueueC$0$size[1000];

static inline bool /*labAppC.SendQueue*/QueueC$0$Queue$empty(void );



static inline uint8_t /*labAppC.SendQueue*/QueueC$0$Queue$size(void );



static inline uint8_t /*labAppC.SendQueue*/QueueC$0$Queue$maxSize(void );



static inline /*labAppC.SendQueue*/QueueC$0$queue_t /*labAppC.SendQueue*/QueueC$0$Queue$head(void );



static void /*labAppC.SendQueue*/QueueC$0$printQueue(void );
#line 85
static inline /*labAppC.SendQueue*/QueueC$0$queue_t /*labAppC.SendQueue*/QueueC$0$Queue$dequeue(void );
#line 97
static inline error_t /*labAppC.SendQueue*/QueueC$0$Queue$enqueue(/*labAppC.SendQueue*/QueueC$0$queue_t newVal);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(
#line 67
message_t * msg, 
...
uint8_t len);
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(
#line 158
message_t * amsg, 
...
am_id_t t);
# 53 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
static error_t /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(message_t *m, error_t err);
# 138 "TDMA.nc"
static void TDMAC$TDMA$sigNewSlot(tSlot slot);
# 151 "SimpleTime.nc"
static tos_time_t TDMAC$SimpleTime$get(void );
#line 58
static tos_time_t TDMAC$SimpleTime$addUint32(tos_time_t a, uint32_t x);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void TDMAC$Timer$startPeriodic(uint32_t dt);
# 70 "TDMAC.nc"
uint16_t TDMAC$interval[1000];
tFrame TDMAC$frame[1000];
bool TDMAC$bIntChanged[1000];
bool TDMAC$bRunning[1000];
...
static inline void TDMAC$Boot$booted(void );
#line 113
static inline void TDMAC$Timer$fired(void );
#line 175
static inline error_t TDMAC$TDMA$start(tSlot sSlot, tFrame sFrame, uint16_t sInterval);
#line 246
static inline uint16_t TDMAC$TDMA$getInterval(void );
#line 260
static inline error_t TDMAC$TDMA$setFrame(tFrame newFrame);
#line 328
static inline void TDMAC$SimpleTime$sigtdmatimecoming(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void SimpleTimeC$Timer0$startPeriodic(uint32_t dt);
# 155 "SimpleTime.nc"
static void SimpleTimeC$SimpleTime$sigtdmatimecoming(void );
# 64 "SimpleTimeC.nc"
enum SimpleTimeC$__nesc_unnamed4365 {
  SimpleTimeC$INTERVAL = 1
};
tos_time_t SimpleTimeC$time[1000];
tos_time_t SimpleTimeC$tdmastarttime[1000];
bool SimpleTimeC$settdma[1000];





static inline void SimpleTimeC$Boot$booted(void );
#line 87
static inline void SimpleTimeC$Timer0$fired(void );
#line 100
static tos_time_t SimpleTimeC$SimpleTime$get(void );
#line 122
static inline void SimpleTimeC$SimpleTime$set_tdmastarttime(tos_time_t t);
#line 233
static inline tos_time_t SimpleTimeC$SimpleTime$addUint32(tos_time_t a, uint32_t ms);
# 46 "/opt/tinyos-2.1.2/tos/interfaces/GeneralIO.nc"
...
# 167 "EASAP.nc"
static void EASAPC$EASAP$frameseted(tFrame newframe);
# 78 "EASAPC.nc"
struct Node EASAPC$inf[1000];

struct DAT;

bool EASAPC$reservedSlot[1000][3000];
...
static inline void EASAPC$Boot$booted(void );
#line 166
static error_t EASAPC$EASAPImp$addSlot(tSlot slot, struct Node *pNode);
#line 253
static inline bool EASAPC$EASAPImp$removeSlot(tSlot slot, struct Node *pNode);
#line 327
static struct Slot *EASAPC$EASAPImp$findSlot(tSlot slot, struct Node *pNode);
#line 376
static inline void EASAPC$EASAP$setFrame(uint16_t frame);
#line 568
static inline struct Node *EASAPC$EASAP$getINF(void );
#line 712
static inline void EASAPC$RandTimer$fired(void );
#line 783
static bool EASAPC$EASAP$isOwnSlot(tSlot slot);
#line 1281
static inline void EASAPC$SimpleTime$sigtdmatimecoming(void );
...
# 55 "LinkEstimator.nc"
inline static uint16_t labC$LinkEstimator$getForwardQuality(uint16_t neighbor){
#line 55
  unsigned short __nesc_result;
#line 55

#line 55
  __nesc_result = LinkEstimatorP$LinkEstimator$getForwardQuality(neighbor);
#line 55
...
#line 55
# 88 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t labC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 727
{
  ...
  uint16_t MymotherLinkquality = 255;
  ...
  from = labC$AMPacket$source(msg);

  linkquality = labC$LinkEstimator$getForwardQuality(from);
  sim_log_debug(216U, "lab1", "My linkQuality to %d is %d\n", from, linkquality);



  if (!labC$my_levelchanged[sim_node()]) 
    {

      if (labC$my_level[sim_node()] > __nesc_ntoh_uint8(rcm->node_level.nxdata)) 
        {
          labC$my_levelchanged[sim_node()] = TRUE;
          labC$my_level[sim_node()] = __nesc_ntoh_uint8(rcm->node_level.nxdata) + 1;
          labC$route_info[sim_node()].parent = from;
          labC$route_info[sim_node()].parent_level = __nesc_ntoh_uint8(rcm->node_level.nxdata);
          sim_log_debug(217U, "lab", "My level is %d my mother node is %d my mother level is %d\n", labC$my_level[sim_node()], labC$route_info[sim_node()].parent, labC$route_info[sim_node()].parent_level);
        }
    }

  if (labC$my_level[sim_node()] - 1 == __nesc_ntoh_uint8(rcm->node_level.nxdata) && labC$my_levelchanged[sim_node()] == TRUE) {
      MymotherLinkquality = labC$LinkEstimator$getForwardQuality(labC$route_info[sim_node()].parent);

      if (MymotherLinkquality > linkquality) {
          sim_log_debug(218U, "lab", "My original mother is %d it's linkquality is %d level is %d\n now my mother is %d,it's linkquality is %d level is %d\n", labC$route_info[sim_node()].parent, MymotherLinkquality, labC$route_info[sim_node()].parent_level, from, linkquality, __nesc_ntoh_uint8(rcm->node_level.nxdata));
          labC$route_info[sim_node()].parent = from;
        }
    }
  ...
  if (labC$my_level[sim_node()] - 1 > __nesc_ntoh_uint8(rcm->node_level.nxdata) && labC$my_levelchanged[sim_node()] == TRUE) {
      ...
      if (MymotherLinkquality > 30 && linkquality < 30) 
        {
          labC$my_level[sim_node()] = __nesc_ntoh_uint8(rcm->node_level.nxdata) + 1;
          sim_log_debug(219U, "lab", " %@#$!@#!@#%&*%%^$ change level!!!My original mother is %d it's linkquality is %d level is %d\n now my newmother is %d,it's linkquality is %d level is %d\n", labC$route_info[sim_node()].parent, MymotherLinkquality, labC$route_info[sim_node()].parent_level, from, linkquality, __nesc_ntoh_uint8(rcm->node_level.nxdata));
          labC$route_info[sim_node()].parent = from;
          labC$route_info[sim_node()].parent_level = __nesc_ntoh_uint8(rcm->node_level.nxdata);
        }
    }
...
#line 78
  __nesc_result = labC$BeaconReceive$receive(msg, payload, len);
#line 78
...
#line 78
  labC$LinkEstimator$evicted(neighbor);
#line 78
}
#line 78
# 287 "LinkEstimatorP.nc"
static inline uint8_t LinkEstimatorP$findWorstNeighborIdx(uint8_t thresholdEETX)
#line 287
{
  uint8_t i;
...
#line 289
  ...
  for (i = 0; i < 50; i++) {
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & VALID_ENTRY)) {
          sim_log_debug(286U, "LI", "Invalid so continuing\n");
          continue;
        }
      if (!(LinkEstimatorP$NeighborTable[sim_node()][i].flags & MATURE_ENTRY)) {
          sim_log_debug(287U, "LI", "Not mature, so continuing\n");
          continue;
        }
      if (LinkEstimatorP$NeighborTable[sim_node()][i].flags & PINNED_ENTRY) {
          sim_log_debug(288U, "LI", "Pinned entry, so continuing\n");
          continue;
        }
...
#line 861
{
  ...
  sim_log_debug(309U, "LI", "LI receiving packet, buf addr: %x\n", payload);
  ...
  if (LinkEstimatorP$SubAMPacket$destination(msg) == AM_BROADCAST_ADDR) {
      ...
      sim_log_debug(310U, "LI", "Got seq: %d from link: %d\n", __nesc_ntoh_uint8(hdr->seq.nxdata), ll_addr);
...
#line 897
      ...
      if (nidx != LinkEstimatorP$INVALID_RVAL) {
          sim_log_debug(311U, "LI", "Found the entry so updating\n");
...
#line 902
        {
          ...
          if (nidx != LinkEstimatorP$INVALID_RVAL) {
              sim_log_debug(312U, "LI", "Found an empty entry\n");
...
#line 908
            {
              ...
              if (nidx != LinkEstimatorP$INVALID_RVAL) {
                  sim_log_debug(313U, "lab", "12345671#!@#!@#!@#7Evicted neighbor %d at idx %d\n", LinkEstimatorP$NeighborTable[sim_node()][nidx].ll_addr, nidx);
...
#line 915
                {
                  sim_log_debug(314U, "lab", "!@#!@#$@#$!@#!@No room in the table\n");
                }
            }
        }
#line 935
...
#line 939
          sim_log_debug(315U, "LI", "Number of footer entries: %d\n", num_entries);
...
#line 970
{
  sim_log_debug(317U, "LI", "Received upper packet. Will signal up\n");
...
#line 609
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(205U, "file", "%x ", b[i]);
  sim_log_debug_clear(206U, "file", "\n");
}
...
#line 103
{
  if (/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()] >= 10) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()] + /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()];

#line 109
      if (emptyIndex >= 10) {
          emptyIndex -= 10;
        }
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[sim_node()][emptyIndex] = newVal;
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()]++;
      sim_log_debug(357U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()]);
      return SUCCESS;
    }
}

# 89 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
inline static error_t labC$MessageRecievePool$put(labC$MessageRecievePool$t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$put(newVal);
#line 89
...
#line 88
{
  if (/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()]) {
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool_t *rval = /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[sim_node()][/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()]];

#line 91
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[sim_node()][/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()]] = (void *)0;
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()]--;
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()]++;
      if (/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()] == 10) {
          /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()] = 0;
        }
      sim_log_debug(356U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
inline static labC$MessageRecievePool$t * labC$MessageRecievePool$get(void ){
#line 97
  nx_struct message_t *__nesc_result;
#line 97

#line 97
  __nesc_result = /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Pool$get();
#line 97
...
#line 97
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$FowardQualityTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$FowardQualityTask);
#line 67
...
#line 57
{
  return /*labAppC.SendQueue*/QueueC$0$size[sim_node()];
}
...
#line 97
{
  if (/*labAppC.SendQueue*/QueueC$0$Queue$size() < /*labAppC.SendQueue*/QueueC$0$Queue$maxSize()) {
      sim_log_debug(364U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*labAppC.SendQueue*/QueueC$0$size[sim_node()]);
      /*labAppC.SendQueue*/QueueC$0$queue[sim_node()][/*labAppC.SendQueue*/QueueC$0$tail[sim_node()]] = newVal;
      /*labAppC.SendQueue*/QueueC$0$tail[sim_node()]++;
      if (/*labAppC.SendQueue*/QueueC$0$tail[sim_node()] == 100) {
#line 102
        /*labAppC.SendQueue*/QueueC$0$tail[sim_node()] = 0;
        }
#line 103
      /*labAppC.SendQueue*/QueueC$0$size[sim_node()]++;
      /*labAppC.SendQueue*/QueueC$0$printQueue();
      return SUCCESS;
    }
  else {
      return FAIL;
...
inline static error_t labC$SendQueue$enqueue(labC$SendQueue$t  newVal){
#line 90
  unsigned char __nesc_result;
#line 90

#line 90
  __nesc_result = /*labAppC.SendQueue*/QueueC$0$Queue$enqueue(newVal);
#line 90
...
#line 90
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
inline static labC$MessageSendPool$t * labC$MessageSendPool$get(void ){
#line 97
  struct __nesc_unnamed4289 *__nesc_result;
#line 97

#line 97
  __nesc_result = /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$get();
#line 97
...
#line 97
#line 72
inline static uint8_t labC$MessageSendPool$size(void ){
#line 72
  unsigned char __nesc_result;
#line 72

#line 72
  __nesc_result = /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$size();
#line 72
...
#line 616
{
  struct relayinginfo *pCurrent = &labC$relayinfo[sim_node()];

#line 618
  sim_log_debug(207U, "lablab", "\n\n\n\n\nnew table begin");
  while (pCurrent != (void *)0) {
      if (labC$is_think_node[sim_node()]) {
          sim_log_debug(208U, "lablab", "from %d,destination%d\n", pCurrent->relay, pCurrent->destination);
        }
...
#line 634
{
  ...
  pCurrent = &labC$relayinfo[sim_node()];

  while (pCurrent->next != (void *)0) {
      pCurrent = pCurrent->next;
    }

  pCurrent->next = malloc(sizeof(struct relayinginfo ));
  if (pCurrent->next == (void *)0) {
#line 659
      sim_log_debug(209U, "lab", "Out of memory happened\n");
    }
  pCurrent->next->next = (void *)0;

  pCurrent->next->relay = from;

  pCurrent->next->destination = relayheader->myaddress;
  pCurrent->next->prev = pCurrent;
  sim_log_debug(210U, "lab", "from %d,destination%d\n", pCurrent->next->relay, pCurrent->next->destination);
}

# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * labC$Packet$getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 669
{
  ...
  link_header_t *relayheader = (link_header_t *)labC$Packet$getPayload(msg, sizeof(link_header_t ));

#line 673
  from = labC$AMPacket$source(msg);
  sim_log_debug(211U, "lab", "QualityRecieve.receive happened\n");
  labC$process_relay_info(from, relayheader);
  labC$print_delay_info();
  if (!labC$is_think_node[sim_node()]) {
      uint8_t i = 0;
      uint8_t payloadLen = labC$Packet$payloadLength(msg);
      message_t *recycle;
      uint8_t *b;
      message_forward_t * qr;

#line 683
      b = (uint8_t *)msg->data;
      if (labC$MessageSendPool$size() == 0) {
          sim_log_debug(212U, "lab", "MessageFowarderPool is full\n");
        }
      else 
        {
          ...
          qr = labC$MessageSendPool$get();
          qr->payloadlength = payloadLen;
          sim_log_debug(213U, "lab", "the message need forwader is as follows\n");
          for (i = 0; i < payloadLen; i++) {

              __nesc_hton_uint8(qr->message.data[i].nxdata, b[i]);
              sim_log_debug(214U, "lab", "%x", __nesc_ntoh_uint8(qr->message.data[i].nxdata));
            }

          sim_log_debug(215U, "lab", "\n");
          labC$SendQueue$enqueue(qr);
          labC$FowardQualityTask$postTask();
        }


      recycle = labC$MessageRecievePool$get();
      labC$MessageRecievePool$put(msg);
      return recycle;
    }
  else {
    ...
    if (labC$is_think_node[sim_node()]) {
        labC$print_packet(msg, len);
        labC$print_packet_into_file(msg, len);
        return msg;
      }
    }
}
...
#line 1174
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(264U, "seqfile", "%x ", b[i]);
  sim_log_debug_clear(265U, "seqfile", "\n");
}
...
{
  message_t *ret = msg;
  test_type_msg_t *rcm = (test_type_msg_t *)labC$Packet$getPayload(msg, sizeof(test_type_msg_t ));

#line 1182
  sim_log_debug(266U, "lab", "\nenter FinalTestRecieve\n");
  if (len != sizeof(test_type_msg_t )) {
#line 1183
      sim_log_debug(267U, "lab1", "\n have not pass test enter FinalTestRecieve\n");
#line 1183
      return msg;
    }
  sim_log_debug(268U, "lab1", "\npass test enter FinalTestRecieve\n");
  if (labC$is_think_node[sim_node()]) {
      sim_log_debug(269U, "lab", "\n****************************\n\n\n$@#$@!#!@#$ from%d,sequencenumber:%d\n**************************\n\n\n", rcm->my_address, rcm->seq);
      labC$print_packet_into_seq_file(msg, len);
      return ret;
    }
  else 
...

    {
      ...
      if (!labC$is_scheduled[sim_node()]) {
          sim_log_debug(270U, "lab", "\n no schedule need more scheduletime FLAUT!!!\n");
          return ret;
        }
      if (!labC$is_trigerred[sim_node()]) {


          sim_log_debug(271U, "lab", "\n not triggered simutanious\n");
          return ret;
        }
      if (!labC$starttest[sim_node()]) {



          sim_log_debug(272U, "lab", "\n not starttest do not enter next frame's slot 0\n");
          return ret;
        }
      sim_log_debug(273U, "lab1", "\n****************************\n\n\nfrom%d,sequencenumber:%d\n**************************\n\n\n", rcm->my_address, rcm->seq);
      sim_log_debug(274U, "lab1", "\n FinalTestRecieve revieve happened\n");
      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
        if (!labC$radioFull[sim_node()]) {
            ret = labC$radioQueue1[sim_node()][labC$radioIn1[sim_node()]];
            labC$radioQueue1[sim_node()][labC$radioIn1[sim_node()]] = msg;
            if (++labC$radioIn1[sim_node()] >= RADIO_QUEUE_LEN) {
              labC$radioIn1[sim_node()] = 0;
              }
            if (labC$radioIn1[sim_node()] == labC$radioOut1[sim_node()]) {
              labC$radioFull1[sim_node()] = TRUE;
              }
          }
        else 
          {
#line 1231
            sim_log_debug(275U, "lab", "FinalTestRecieve packet droped\n");
            sim_log_debug_clear(276U, "filew", "final test droped%d \n", TOS_NODE_ID);
          }
#line 1233
...
# 52 "/opt/tinyos-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t labC$Random$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void labC$RadioTimer$startOneShot(uint32_t dt){
#line 73
...
#line 73
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$radioSendTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$radioSendTask);
#line 67
...
static inline bool EASAPC$EASAPImp$removeSlot(tSlot slot, struct Node *pNode)
{
  ...
  pSlot = EASAPC$EASAPImp$findSlot(slot, pNode);
  ...
  if (pSlot == pNode->slots) 
    {
      ...
      pNode->slots->prev = (void *)0;
    }
  else 
    {

      if (pSlot->prev != (void *)0) {
        pSlot->prev->next = pSlot->next;
        }
      if (pSlot->next != (void *)0) {
...
# 89 "EASAPImp.nc"
inline static bool labC$EASAPImp$removeSlot(tSlot slot, struct Node *pNode){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = EASAPC$EASAPImp$removeSlot(slot, pNode);
#line 89
...
#line 89
#line 66
inline static bool labC$EASAPImp$addSlot(tSlot slot, struct Node *pNode){
#line 66
  unsigned char __nesc_result;
#line 66

#line 66
  __nesc_result = EASAPC$EASAPImp$addSlot(slot, pNode);
#line 66
...
static inline error_t TDMAC$TDMA$setFrame(tFrame newFrame)
{
  ...
  if (newFrame < 2 || newFrame > 3000) {
    return TDMA_E_INVALID_FRAME_LENGTH;
    }

  TDMAC$frame[sim_node()] = newFrame;

  return SUCCESS;
}

# 99 "TDMA.nc"
inline static error_t labC$TDMA$setFrame(tFrame newFrame){
#line 99
  unsigned char __nesc_result;
#line 99

#line 99
  __nesc_result = TDMAC$TDMA$setFrame(newFrame);
#line 99
...
# 167 "EASAP.nc"
inline static void EASAPC$EASAP$frameseted(tFrame newframe){
#line 167
  labC$EASAP$frameseted(newframe);
#line 167
}
#line 167
# 376 "EASAPC.nc"
static inline void EASAPC$EASAP$setFrame(uint16_t frame)
{
  if (EASAPC$inf[sim_node()].frame >= 3000) {
    return;
    }

  EASAPC$inf[sim_node()].frame = frame;
  sim_log_debug(377U, "lab1", "currentframe length is %d\n", EASAPC$inf[sim_node()].frame);


  EASAPC$EASAP$frameseted(EASAPC$inf[sim_node()].frame);
}

# 201 "EASAP.nc"
inline static void labC$EASAP$setFrame(uint16_t frame){
#line 201
  EASAPC$EASAP$setFrame(frame);
#line 201
}
#line 201
# 151 "SimpleTime.nc"
inline static tos_time_t labC$SimpleTime$get(void ){
#line 151
  unsigned int __nesc_result;
#line 151

#line 151
  __nesc_result = SimpleTimeC$SimpleTime$get();
#line 151
...
#line 124
    {
      SimpleTimeC$tdmastarttime[sim_node()] = t;
      SimpleTimeC$settdma[sim_node()] = TRUE;
      sim_log_debug(366U, "lab", "settdma %d", SimpleTimeC$settdma[sim_node()]);
    }
#line 128
    __nesc_atomic_end(__nesc_atomic); }
}
...
# 154 "SimpleTime.nc"
inline static void labC$SimpleTime$set_tdmastarttime(tos_time_t t){
#line 154
  SimpleTimeC$SimpleTime$set_tdmastarttime(t);
#line 154
}
#line 154
# 568 "EASAPC.nc"
static inline struct Node *EASAPC$EASAP$getINF(void )
{
  return &EASAPC$inf[sim_node()];
}

# 58 "EASAP.nc"
inline static struct Node *labC$EASAP$getINF(void ){
#line 58
  struct Node *__nesc_result;
#line 58

#line 58
  __nesc_result = EASAPC$EASAP$getINF();
#line 58
...
#line 837
{
  ...
  message_t *ret = msg;
  test_serial_msg_t *rcm = (test_serial_msg_t *)labC$Packet$getPayload(msg, sizeof(test_serial_msg_t ));
...
#line 841
  ...
  if (rcm->myaddress == TOS_NODE_ID) {
      ...
      int i = 0;
      struct Node *pCurrent = labC$EASAP$getINF();
      struct Slot *pSlot;


      labC$SimpleTime$set_tdmastarttime(rcm->tdma_start_time);
      sim_log_debug(225U, "lab", "\nrcm->tdma_start_time is %d\n", rcm->tdma_start_time);
      sim_log_debug(226U, "lab", "my simpletime is %d\n", labC$SimpleTime$get());

      labC$is_scheduled[sim_node()] = TRUE;
      sim_log_debug(227U, "lab", "\nThe relayinfo suceessfully reach destination\n");
      sim_log_debug_clear(228U, "filew", "destination %d", TOS_NODE_ID);
      sim_log_debug(229U, "lab", "'%d','%d','%d','%d'", rcm->myaddress, rcm->motheraddress, rcm->length, rcm->framelenghth);
      for (i = 0; i < rcm->length; i++) {
          sim_log_debug(230U, "lab", "'%d',", rcm->a[i]);
        }
      sim_log_debug(231U, "lab", "\n");
      ...
      labC$route_info[sim_node()].parent = rcm->motheraddress;
      sim_log_debug(232U, "lab1", "my parent address is %d\n", labC$route_info[sim_node()].parent);


      labC$EASAP$setFrame(rcm->framelenghth);
      labC$TDMA$setFrame(rcm->framelenghth);
      for (i = 0; i < rcm->length; i++) {
          labC$EASAPImp$addSlot(rcm->a[i], pCurrent);
          if (rcm->a[i] == labC$rand_slot[sim_node()]) {
              rand_same_assign = TRUE;
              sim_log_debug(233U, "lab1", "before happened rand_same_assign= %d \n", rand_same_assign);
              sim_log_debug(234U, "lab1", "******^%#!@#!@assign the same happened\n");
            }
        }

      if (!rand_same_assign && labC$relayreccount[sim_node()] == 0) {
          sim_log_debug(235U, "lab1", "After happened rand_same_assign= %d \n", rand_same_assign);
          sim_log_debug(236U, "lab1", "******^%#!@#!@relayrecount = %d\n", labC$relayreccount[sim_node()]);
          labC$EASAPImp$removeSlot(labC$rand_slot[sim_node()], pCurrent);
        }
      labC$relayreccount[sim_node()] = labC$relayreccount[sim_node()] + 1;
      return ret;
    }


  sim_log_debug(237U, "lab", "\nRelay revieve happened\n");



  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    if (!labC$radioFull[sim_node()]) {
        ret = labC$radioQueue[sim_node()][labC$radioIn[sim_node()]];
        labC$radioQueue[sim_node()][labC$radioIn[sim_node()]] = msg;
        if (++labC$radioIn[sim_node()] >= RADIO_QUEUE_LEN) {
          labC$radioIn[sim_node()] = 0;
          }
        if (labC$radioIn[sim_node()] == labC$radioOut[sim_node()]) {
          labC$radioFull[sim_node()] = TRUE;
          }
#line 907
        if (!labC$is_busy[sim_node()]) {
            labC$radioSendTask$postTask();
          }
        else {
            labC$RadioTimer$startOneShot(2000 + labC$Random$rand16() % 2000);
          }
      }
    else {
#line 914
        sim_log_debug(238U, "lab", "serial packet droped\n");
        sim_log_debug_clear(239U, "filew", "serial packet droped in relay receive %d\n", TOS_NODE_ID);
      }
#line 916
    __nesc_atomic_end(__nesc_atomic); }
  return ret;
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0x40909ac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40909ac8) {
#line 78
    case 10:
#line 78
...
#line 78
    case 11:
#line 78
      __nesc_result = labC$QualityRecieve$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 12:
#line 78
      __nesc_result = labC$RelayReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    case 13:
#line 78
      __nesc_result = labC$FinalTestRecieve$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0x40909ac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 436
                {
                  sim_log_debug(290U, "LI", "Making link: %d mature\n", i);
                  ne->flags |= MATURE_ENTRY;
                  totalPkt = ne->rcvcnt + ne->failcnt;
                  sim_log_debug(291U, "LI", "MinPkt: %d, totalPkt: %d\n", minPkt, totalPkt);
                  if (totalPkt < minPkt) {
...
#line 448
                    {
                      ...
                      sim_log_debug(292U, "LI,LITest", "  %hu: %hhu -> %hhu", ne->ll_addr, ne->inquality, (LinkEstimatorP$ALPHA * ne->inquality + (10 - LinkEstimatorP$ALPHA) * newEst + 5) / 10);
            ...
            {
              sim_log_debug(293U, "LI", " - entry %i is invalid.\n", (int )i);
            }
        }
    }
}
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0x40906178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0x40906178, msg, payload, len);
#line 78
...
#line 962
{
  ...
  sim_log_debug(243U, "lab1", "serial recieve happened\n");
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    if (!labC$radioFull[sim_node()]) {
        ret = labC$radioQueue[sim_node()][labC$radioIn[sim_node()]];
        labC$radioQueue[sim_node()][labC$radioIn[sim_node()]] = msg;
        ...
        if (labC$firstserialmessage[sim_node()]) {
            labC$tdmastarttime[sim_node()] = labC$SimpleTime$get() + 600000;
            sim_log_debug(244U, "lab", "tdma start time is %d\n", labC$tdmastarttime[sim_node()]);
            labC$firstserialmessage[sim_node()] = FALSE;
          }
        ...
        if (!labC$is_busy[sim_node()]) {
            ...
            sim_log_debug(245U, "lab", "current radio is busy*********\n");
            labC$RadioTimer$startOneShot(200 + labC$Random$rand16() % 200);
          }
      }
    else {
#line 993
        sim_log_debug(246U, "lab", "serial packet droped\n");
        sim_log_debug_clear(247U, "filew", "serial packet droped in serial recieve %d\n", TOS_NODE_ID);
      }
#line 995
    __nesc_atomic_end(__nesc_atomic); }
  return ret;
...
# 252 "/opt/tinyos-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline message_t *SerialActiveMessageC$Receive$default$receive(am_id_t id, message_t *msg, void *payload, uint8_t len)
#line 252
{
  return msg;
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0x40a1e548, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x40a1e548) {
#line 78
    case AM_TEST_SERIAL_MSG:
#line 78
      __nesc_result = labC$SerialReceive$receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = SerialActiveMessageC$Receive$default$receive(arg_0x40a1e548, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t labC$TDMAControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void TDMAC$Timer$startPeriodic(uint32_t dt){
#line 64
...
static inline error_t TDMAC$TDMA$start(tSlot sSlot, tFrame sFrame, uint16_t sInterval)
{
  ...
  if (TDMAC$bRunning[sim_node()] == TRUE) {
  ...
  TDMAC$frame[sim_node()] = sFrame;
  TDMAC$interval[sim_node()] = sInterval;





  TDMAC$Timer$startPeriodic(TDMAC$interval[sim_node()]);

  TDMAC$bRunning[sim_node()] = TRUE;
...
# 63 "TDMA.nc"
inline static error_t labC$TDMA$start(tSlot sSlot, tFrame sFrame, uint16_t sInterval){
#line 63
  unsigned char __nesc_result;
#line 63

#line 63
  __nesc_result = TDMAC$TDMA$start(sSlot, sFrame, sInterval);
#line 63
...
#line 1147
{
  if (err == SUCCESS) {
      ...
      labC$TDMA$start(1, 100, 1024);

      labC$rand_slot[sim_node()] = labC$Random$rand16() % 100;
      labC$EASAPImp$addSlot(labC$rand_slot[sim_node()], pCurrent);
      pSlot = pCurrent->slots;
      while (pSlot != (void *)0) {
          sim_log_debug(263U, "lab", "My slot is %d *************\n", pSlot->slot);
          pSlot = pSlot->next;
        }
    }
  else {
      labC$TDMAControl$start();
    }
}
...
{
  if (err == SUCCESS) {
      labC$radioFull[sim_node()] = FALSE;
      labC$radioFull1[sim_node()] = FALSE;


      labC$QualityTimer$startOneShot(500000);
    }
}
...
#line 113
  labC$AMControl$startDone(error);
#line 113
  labC$TDMAControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
#line 138
  labC$AMControl$stopDone(error);
#line 138
  labC$TDMAControl$stopDone(error);
#line 138
}
#line 138
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0x40909108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x40909108, msg, error);
#line 110
}
#line 110
...
# 260 "/opt/tinyos-2.1.2/tos/lib/tossim/sf/sim/SerialActiveMessageC.nc"
static inline void SerialActiveMessageC$AMSend$default$sendDone(uint8_t id, message_t *msg, error_t err)
#line 260
{
  return;
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0x40a1fae8, message_t * msg, error_t error){
#line 110
  switch (arg_0x40a1fae8) {
#line 110
    case AM_TEST_SERIAL_MSG:
#line 110
      labC$SerialSend$sendDone(msg, error);
#line 110
      break;
#line 110
    default:
#line 110
      SerialActiveMessageC$AMSend$default$sendDone(arg_0x40a1fae8, msg, error);
#line 110
      break;
#line 110
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t labC$FinalTestSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$send(addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
inline static error_t labC$PacketAcknowledgements$requestAck(message_t * msg){
#line 59
  unsigned char __nesc_result;
#line 59
...
inline static uint8_t labC$Packet$maxPayloadLength(void ){
#line 106
  unsigned char __nesc_result;
#line 106
...
#line 225
{
  ...
  if (labC$is_trigerred[sim_node()] == FALSE) {
      sim_log_debug(156U, "lab", "NOT TRIGGERED!FALSE!\n");
      return;
    }
  if (labC$is_busy[sim_node()]) {
      sim_log_debug(157U, "lab", "current radio busy final test\n");
      return;
    }
  finaltestmsg = (test_type_msg_t *)labC$Packet$getPayload(&labC$testMsgBuffer[sim_node()], labC$Packet$maxPayloadLength());
  finaltestmsg->my_address = TOS_NODE_ID;
  if (labC$My_test_msg_need_retrasmit[sim_node()]) {
      sim_log_debug(158U, "lab", "in retransmit current seq number is %d\n", labC$seq[sim_node()] - 1);
      finaltestmsg->seq = labC$seq[sim_node()] - 1;
    }
  else 
#line 242
    {
      sim_log_debug(159U, "lab", "in retransmit current seq number is %d\n", labC$seq[sim_node()]);
      finaltestmsg->seq = labC$seq[sim_node()];
      labC$seq[sim_node()]++;
    }

  sim_log_debug(160U, "lab", "finaltestMymessageSend: %s\n", sim_time_string());

  labC$PacketAcknowledgements$requestAck(&labC$testMsgBuffer[sim_node()]);
  labC$From_finaltestMymessageSend[sim_node()] = TRUE;
  if (labC$FinalTestSend$send(labC$route_info[sim_node()].parent, &labC$testMsgBuffer[sim_node()], sizeof(test_type_msg_t )) == SUCCESS) {
      labC$is_busy[sim_node()] = TRUE;
    }
}

# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$finaltestMymessageSend$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$finaltestMymessageSend);
#line 67
...
#line 264
  if (labC$is_trigerred[sim_node()] == FALSE) {
      sim_log_debug(161U, "lab", " in task sendtest_relay_Task() NOT TRIGGERED!FALSE!\n");
      return;
    }

  if (labC$is_busy[sim_node()]) {

      sim_log_debug(162U, "lab", "sendtest message FLAUT!!!Current Radio is busy\n");
      return;
    }

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    if (labC$radioIn1[sim_node()] == labC$radioOut1[sim_node()] && !labC$radioFull1[sim_node()]) {
        ...
        sim_log_debug(163U, "lab1", "queue empty, send my message only_send_one_my_msg is %d\n", labC$only_send_one_my_msg[sim_node()]);



        if (!labC$only_send_one_my_msg[sim_node()]) {
            labC$finaltestMymessageSend$postTask();
          }
        {
#line 290
          __nesc_atomic_end(__nesc_atomic); 
...
#line 292
    __nesc_atomic_end(__nesc_atomic); }
  msg = labC$radioQueue1[sim_node()][labC$radioOut1[sim_node()]];


  labC$PacketAcknowledgements$requestAck(msg);
  labC$From_sendtest_relay_Task[sim_node()] = TRUE;
  if (labC$FinalTestSend$send(labC$route_info[sim_node()].parent, msg, sizeof(test_type_msg_t )) == SUCCESS) {
      labC$is_busy[sim_node()] = TRUE;
      sim_log_debug(164U, "lab1", "FinalTestSend been successfully send\n");
    }
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t labC$QualitySend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$send(addr, msg, len);
#line 80
...
#line 65
{
  return /*labAppC.SendQueue*/QueueC$0$queue[sim_node()][/*labAppC.SendQueue*/QueueC$0$head[sim_node()]];
}

# 73 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static labC$SendQueue$t  labC$SendQueue$head(void ){
#line 73
  struct __nesc_unnamed4289 *__nesc_result;
#line 73

#line 73
  __nesc_result = /*labAppC.SendQueue*/QueueC$0$Queue$head();
#line 73
...
#line 53
{
  return /*labAppC.SendQueue*/QueueC$0$size[sim_node()] == 0;
}

# 50 "/opt/tinyos-2.1.2/tos/interfaces/Queue.nc"
inline static bool labC$SendQueue$empty(void ){
#line 50
  unsigned char __nesc_result;
#line 50

#line 50
  __nesc_result = /*labAppC.SendQueue*/QueueC$0$Queue$empty();
#line 50
...
#line 50
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void labC$FowarderTimer$startOneShot(uint32_t dt){
#line 73
...
#line 355
{
  ...
  message_forward_t * queue;

#line 364
  if (labC$is_busy[sim_node()]) {
      sim_log_debug(171U, "lab", "current radio is busy. Fowardtimer fired 100000later\n");
      labC$FowarderTimer$startOneShot(1000 + labC$Random$rand16() % 6000);
      return;
    }
  if (labC$SendQueue$empty()) {
      sim_log_debug(172U, "lab", "The queque is empty i have nothing to send\n");
      return;
    }
  else {
      queue = labC$SendQueue$head();
      labC$PacketAcknowledgements$requestAck(& queue->message);

      if (labC$QualitySend$send(labC$route_info[sim_node()].parent, & queue->message, queue->payloadlength) != SUCCESS) 
        {
#line 378
          sim_log_debug(173U, "lab", "something is wrong in the send of FowardQualityTask\n");
          return;
        }
      else {
#line 381
          labC$is_busy[sim_node()] = TRUE;
#line 381
          labC$From_ForwardQuality_task[sim_node()] = TRUE;
        }
    }
}

# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$sendQualityTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$sendQualityTask);
#line 67
...
#line 182
{
  return (linkest_footer_t * )(len + (uint8_t *)labC$Packet$getPayload(m, len + sizeof(linkest_footer_t )));
}
...
#line 192
  if (number_footers > 0) {
      ...
      footer = labC$getlinkqualityFooter(msg, sizeof(link_header_t ));
      {
        uint8_t i;
        neighbor_stat_entry_t * neighborLists;
...
#line 106
# 739 "LinkEstimatorP.nc"
static inline linkest_footer_t *LinkEstimatorP$getlinkqualityFooter(message_t * m, uint8_t len)
#line 739
{
  return (linkest_footer_t * )(len + (uint8_t *)LinkEstimatorP$SubPacket$getPayload(m, len + sizeof(linkest_footer_t )));
}
...
#line 756
  ...
  footer = LinkEstimatorP$getlinkqualityFooter(msg, len);
  maxEntries = (LinkEstimatorP$SubPacket$maxPayloadLength() - len) / sizeof(linkest_footer_t );





  sim_log_debug(305U, "LI", "Max payload is: %d, maxEntries is: %d\n", LinkEstimatorP$SubPacket$maxPayloadLength(), maxEntries);
  j = 0;
...
#line 781
      ...
      neighborLists = (neighbor_stat_entry_t * )footer->neighborList;
      k = (LinkEstimatorP$prevSentlinkqualityIdx[sim_node()] + i + 1) % 50;
      ...
      LinkEstimatorP$NeighborTable[sim_node()][k].flags & MATURE_ENTRY) {
          ...
          __nesc_hton_uint8(neighborLists[j].inquality.nxdata, LinkEstimatorP$NeighborTable[sim_node()][k].outquality);
          newPrevSentIdx = k;
          sim_log_debug(306U, "lab", "Loaded on footer: %d %d %d\n", j, __nesc_ntoh_uint16(neighborLists[j].ll_addr.nxdata), __nesc_ntoh_uint8(neighborLists[j].inquality.nxdata));

          j++;
        }
    }
  LinkEstimatorP$prevSentlinkqualityIdx[sim_node()] = newPrevSentIdx;


  link_header = LinkEstimatorP$SubPacket$getPayload(msg, sizeof(link_header_t ));
...
# 83 "LinkEstimator.nc"
inline static uint8_t labC$LinkEstimator$Loadestimation(message_t *msg, uint8_t len){
#line 83
  unsigned char __nesc_result;
#line 83

#line 83
  __nesc_result = LinkEstimatorP$LinkEstimator$Loadestimation(msg, len);
#line 83
...
#line 83
# 84 "/opt/tinyos-2.1.2/tos/system/PoolP.nc"
static inline uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$maxSize(void )
#line 84
{
  return 100;
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
inline static uint8_t labC$MessageSendPool$maxSize(void ){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$maxSize();
#line 80
...
#line 386
{
  ...
  if (labC$is_busy[sim_node()]) {
      sim_log_debug(174U, "lab1", "current radio is busy. Quality timer fired 100000later\n");
      labC$QualityTimer_is_from_task[sim_node()] = TRUE;
      labC$QualityTimer$startOneShot(1000 + labC$Random$rand16() % 6000);
      return;
    }

  sim_log_debug(175U, "lab1", "MessageSendPool's size is %d \nMessageSendPool.maxSize is %d\n", labC$MessageSendPool$size(), labC$MessageSendPool$maxSize());
  if (labC$MessageSendPool$size() == 0) 
    {
      sim_log_debug(176U, "lab", "the currentpool is full\n");
      labC$QualityTimer_is_from_task[sim_node()] = TRUE;
      labC$QualityTimer$startOneShot(1000 + labC$Random$rand16() % 6000);
      return;
    }
  ...
  labC$qe[sim_node()] = labC$MessageSendPool$get();


  labC$link_header[sim_node()] = labC$Packet$getPayload(& labC$qe[sim_node()]->message, sizeof(link_header_t ));
  labC$link_header[sim_node()]->myaddress = TOS_NODE_ID;
  if (labC$times_left[sim_node()] == 1) {
      labC$link_header[sim_node()]->messagetype = 1;
    }
  else {
      labC$link_header[sim_node()]->messagetype = labC$times_left[sim_node()];
    }
  labC$link_header[sim_node()]->flags = 0;

  labC$newlength[sim_node()] = labC$LinkEstimator$Loadestimation(& labC$qe[sim_node()]->message, sizeof labC$link_header[sim_node()]);





  sim_log_debug(177U, "lab", "the number of footer is %d\n", labC$link_header[sim_node()]->flags & NUM_ENTRIES_FLAG);

  labC$print_footer_table(& labC$qe[sim_node()]->message, labC$link_header[sim_node()]->flags & NUM_ENTRIES_FLAG);

  labC$print_packet(& labC$qe[sim_node()]->message, labC$newlength[sim_node()]);
  sim_log_debug(178U, "lab1", "newlength%d\n", labC$newlength[sim_node()]);

  labC$PacketAcknowledgements$requestAck(& labC$qe[sim_node()]->message);
  if (labC$QualitySend$send(labC$route_info[sim_node()].parent, & labC$qe[sim_node()]->message, labC$newlength[sim_node()]) == SUCCESS) {
      labC$is_busy[sim_node()] = TRUE;
      labC$From_SendQuality_task[sim_node()] = TRUE;
    }


  labC$times_left[sim_node()]--;
  if (labC$times_left[sim_node()] > 0) 
    {
#line 444
      labC$sendQualityTask$postTask();
    }
  else 
#line 445
    {

      labC$QualityTimer_is_from_task[sim_node()] = FALSE;
    }
}

# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
...
#line 162
#line 103
inline static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 10);
  return /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
...
#line 80
  __nesc_result = /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 80
...
#line 157
  sim_log_debug(282U, "LI", "newlen1 = %d\n", len);
...
#line 177
  ...
  sim_log_debug(283U, "LI", "Max payload is: %d, maxEntries is: %d\n", LinkEstimatorP$SubPacket$maxPayloadLength(), maxEntries);
  ...
  for (i = 0; i < 50 && j < maxEntries; i++) {
      ...
      k = (LinkEstimatorP$prevSentIdx[sim_node()] + i + 1) % 50;
      ...
      LinkEstimatorP$NeighborTable[sim_node()][k].flags & MATURE_ENTRY) {
          ...
          newPrevSentIdx = k;
          sim_log_debug(284U, "LI", "Loaded on footer: %d %d %d\n", j, __nesc_ntoh_uint16(neighborLists[j].ll_addr.nxdata), __nesc_ntoh_uint8(neighborLists[j].inquality.nxdata));
  ...
  sim_log_debug(285U, "LI", "newlen2 = %d\n", newlen);
  return newlen;
}
...
#line 824
{
  ...
  sim_log_debug(307U, "LITest", "%s packet of length %hhu became %hhu\n", __FUNCTION__, len, newlen);
  sim_log_debug(308U, "LI", "Sending seq: %d\n", LinkEstimatorP$linkEstSeq[sim_node()]);
  LinkEstimatorP$print_packet(msg, newlen);
  return LinkEstimatorP$AMSend$send(addr, msg, newlen);
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t labC$BeaconSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80
...
inline static uint8_t labC$BeaconSend$maxPayloadLength(void ){
#line 123
  unsigned char __nesc_result;
#line 123
...
inline static void * labC$BeaconSend$getPayload(message_t * msg, uint8_t len){
#line 135
  void *__nesc_result;
#line 135
...
#line 577
  ...
  labC$beaconMsg[sim_node()] = labC$BeaconSend$getPayload(&labC$beaconMsgBuffer[sim_node()], labC$BeaconSend$maxPayloadLength());
  __nesc_hton_uint8(labC$beaconMsg[sim_node()]->messagetype.nxdata, 1);
  __nesc_hton_uint8(labC$beaconMsg[sim_node()]->node_level.nxdata, labC$my_level[sim_node()]);
  sim_log_debug(203U, "lab1", "Beacontask %s\n", sim_time_string());



  if (
#line 585
  labC$BeaconSend$send(AM_BROADCAST_ADDR, 
  &labC$beaconMsgBuffer[sim_node()], 
  sizeof(radio_type_msg_t )) == SUCCESS) {
      labC$is_busy[sim_node()] = TRUE;
    }
  else 
    {
      sim_log_debug(204U, "lab", "Fail to send the becon message\n");
    }
}

# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t labC$RelaySend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$send(addr, msg, len);
#line 80
...
#line 804
  if (labC$is_busy[sim_node()]) {
      ...
      sim_log_debug(222U, "lab", "Current Radio is busy\n");
      labC$RadioTimer$startOneShot(2000 + labC$Random$rand16() % 5000);
      return;
    }

  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
    if (labC$radioIn[sim_node()] == labC$radioOut[sim_node()] && !labC$radioFull[sim_node()]) {
        {
#line 813
          __nesc_atomic_end(__nesc_atomic); 
#line 813
...
#line 815
    __nesc_atomic_end(__nesc_atomic); }
  msg = labC$radioQueue[sim_node()][labC$radioOut[sim_node()]];
  rcm = (test_serial_msg_t *)labC$Packet$getPayload(msg, sizeof(test_serial_msg_t ));


  if (labC$is_think_node[sim_node()]) {
      rcm->tdma_start_time = labC$tdmastarttime[sim_node()];
    }
  len = labC$Packet$payloadLength(msg);

  addr = labC$get_relay_address(rcm->myaddress);
  sim_log_debug(223U, "lab", "\n*****next address is %d\n", addr);

  labC$PacketAcknowledgements$requestAck(msg);
  if (labC$RelaySend$send(addr, msg, len) == SUCCESS) {
      labC$is_busy[sim_node()] = TRUE;
      sim_log_debug(224U, "lab1", "serial message has been successfully send\n");
    }
}

# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$sendtest_relay_Task$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$sendtest_relay_Task);
#line 67
...
#line 67
inline static error_t labC$sendBeaconTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$sendBeaconTask);
#line 67
...
#line 1062
{
  sim_log_debug(249U, "lab1", "owbslothandler fired at %s\n", sim_time_string());

  if (!labC$quality_time_start[sim_node()]) {
      labC$sendBeaconTask$postTask();
    }


  sim_log_debug(250U, "lab1", "in the slot handler only starttest equal %d\n", labC$starttest[sim_node()]);
  sim_log_debug(251U, "lab1", "current slot is %d current logic time is %d\n", labC$cSlot[sim_node()], labC$SimpleTime$get());
  if (labC$is_trigerred[sim_node()] && !labC$is_think_node[sim_node()] && labC$starttest[sim_node()]) {
      labC$sendtest_relay_Task$postTask();
      sim_log_debug(252U, "lab", "current slot is %d current logic time is %d\n", labC$cSlot[sim_node()], labC$SimpleTime$get());
    }
}

# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void labC$DelayTimer$startOneShot(uint32_t dt){
#line 73
...
#line 1081
{
  labC$DelayTimer$startOneShot(TRANS_DELAY);
}
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x40732970){
#line 75
  switch (arg_0x40732970) {
#line 75
...
#line 75
      break;
#line 75
    case labC$finaltestMymessageSend:
#line 75
      labC$finaltestMymessageSend$runTask();
#line 75
      break;
#line 75
    case labC$sendtest_relay_Task:
#line 75
      labC$sendtest_relay_Task$runTask();
#line 75
      break;
#line 75
    case labC$FowardQualityTask:
#line 75
      labC$FowardQualityTask$runTask();
#line 75
      break;
#line 75
    case labC$sendQualityTask:
#line 75
      labC$sendQualityTask$runTask();
#line 75
      break;
#line 75
    case labC$sendBeaconTask:
#line 75
      labC$sendBeaconTask$runTask();
#line 75
      break;
#line 75
    case labC$radioSendTask:
#line 75
      labC$radioSendTask$runTask();
#line 75
      break;
#line 75
    case labC$ownSlotHandler:
#line 75
      labC$ownSlotHandler$runTask();
#line 75
      break;
#line 75
    case labC$startDelayTimer:
#line 75
      labC$startDelayTimer$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0x40732970);
#line 75
      break;
#line 75
    }
...
#line 726
  ...
  sim_log_debug(304U, "lab", "maturecount: %d maxEntries:%d \n", maturecount, maxEntries);
...
# 86 "LinkEstimator.nc"
inline static uint8_t labC$LinkEstimator$Gettimes(message_t *msg, uint8_t len){
#line 86
  unsigned char __nesc_result;
#line 86

#line 86
  __nesc_result = LinkEstimatorP$LinkEstimator$Gettimes(msg, len);
#line 86
...
#line 1288
{
  ...
  labC$quality_time_start[sim_node()] = TRUE;
  if (labC$is_think_node[sim_node()]) {
#line 1292
      return;
    }
#line 1293
  if (!labC$QualityTimer_is_from_task[sim_node()]) 

    {
#line 1295
      labC$times_left[sim_node()] = 0;
      labC$times_left[sim_node()] = labC$LinkEstimator$Gettimes(&labC$qualityMsgBuffer[sim_node()], sizeof labC$link_header[sim_node()]);
    }
#line 1297
  sim_log_debug(280U, "lab", "times_left: %d\n", labC$times_left[sim_node()]);
  labC$sendQualityTask$postTask();
  sim_log_debug(281U, "lab", "Quality Timer fired at %s\n", sim_time_string());
}
...
{
  labC$FowardQualityTask$postTask();
  sim_log_debug(279U, "lab", "FowarderTime fired at %s\n", sim_time_string());
}
...
{
  labC$radioSendTask$postTask();
  sim_log_debug(248U, "lab", "RadioTimer fired at %s\n", sim_time_string());
}

# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$ownSlotHandler$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$ownSlotHandler);
#line 67
...
#line 1095
{
  sim_log_debug(253U, "lab1", "delaytimer fired %s\n", sim_time_string());
  labC$ownSlotHandler$postTask();
  return;
}
...
#line 450
{
  sim_log_debug(179U, "lab", "@@@@@@@@quality send retransmit length is %d", labC$qualitysendlength[sim_node()]);
  labC$PacketAcknowledgements$requestAck(&labC$qualitysend_retransmit[sim_node()]);
  if (labC$QualitySend$send(labC$route_info[sim_node()].parent, &labC$qualitysend_retransmit[sim_node()], labC$qualitysendlength[sim_node()]) != SUCCESS) 
    {
#line 454
      sim_log_debug(180U, "lab", "something is wrong in the Msg retransmit\n");
    }
}
...
#line 456
{
  sim_log_debug(181U, "lab", "@@@@@quality send retransmit length is %d", labC$qualityforwardlength[sim_node()]);
  labC$PacketAcknowledgements$requestAck(&labC$qualityforward_retransmit[sim_node()]);
  if (labC$QualitySend$send(labC$route_info[sim_node()].parent, &labC$qualityforward_retransmit[sim_node()], labC$qualityforwardlength[sim_node()]) != SUCCESS) 
    {
#line 460
      sim_log_debug(182U, "lab", "something is wrong in the Msg retransmit\n");
    }
}
...
#line 1243
{
  labC$is_trigerred[sim_node()] = TRUE;
  sim_log_debug(277U, "lab1", " simple time tdma slot come, slots is triggered\n the current slot is %d\n", labC$cSlot[sim_node()]);
}
...
# 155 "SimpleTime.nc"
inline static void SimpleTimeC$SimpleTime$sigtdmatimecoming(void ){
#line 155
  EASAPC$SimpleTime$sigtdmatimecoming();
#line 155
  TDMAC$SimpleTime$sigtdmatimecoming();
#line 155
  labC$SimpleTime$sigtdmatimecoming();
#line 155
}
#line 155
# 233 "SimpleTimeC.nc"
...
static inline void SimpleTimeC$Timer0$fired(void )
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 89
    SimpleTimeC$time[sim_node()] = SimpleTimeC$SimpleTime$addUint32(SimpleTimeC$time[sim_node()], SimpleTimeC$INTERVAL);
#line 89
    __nesc_atomic_end(__nesc_atomic); }
  if (SimpleTimeC$time[sim_node()] == SimpleTimeC$tdmastarttime[sim_node()] && SimpleTimeC$settdma[sim_node()]) {

      SimpleTimeC$SimpleTime$sigtdmatimecoming();
      sim_log_debug(365U, "lab", "it's time to let tdma start !!!!\n");
    }
}

# 95 "EASAP.nc"
inline static bool labC$EASAP$isOwnSlot(tSlot slot){
#line 95
  unsigned char __nesc_result;
#line 95

#line 95
  __nesc_result = EASAPC$EASAP$isOwnSlot(slot);
#line 95
...
#line 95
# 67 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t labC$startDelayTimer$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(labC$startDelayTimer);
#line 67
...
static inline uint16_t TDMAC$TDMA$getInterval(void )
{
  return TDMAC$interval[sim_node()];
}

# 89 "TDMA.nc"
inline static uint16_t labC$TDMA$getInterval(void ){
#line 89
  unsigned short __nesc_result;
#line 89

#line 89
  __nesc_result = TDMAC$TDMA$getInterval();
#line 89
...
#line 1100
{
  ...
  labC$cSlot[sim_node()] = slot;
  labC$pocet_odeslanych[sim_node()] = 0;
  labC$remSlotsTime[sim_node()] = (uint32_t )labC$TDMA$getInterval();
  if (TOS_NODE_ID == 1) {
    sim_log_debug(254U, "lab1", "SLOT NUMBER %d\n", labC$cSlot[sim_node()]);
    }
#line 1107
  labC$cas1[sim_node()] = labC$SimpleTime$get();


  if (labC$is_trigerred[sim_node()] && labC$cSlot[sim_node()] == 0) {
      if (labC$starttest[sim_node()] && labC$testframenumber[sim_node()] <= 0) {
          labC$onlystartonce[sim_node()] = FALSE;
          labC$starttest[sim_node()] = FALSE;
          sim_log_debug(255U, "lab", "only startonce equal %d\n", labC$onlystartonce[sim_node()]);
          sim_log_debug(256U, "lab", "only starttest equal %d\n", labC$starttest[sim_node()]);
        }
      if (labC$onlystartonce[sim_node()]) {
          labC$starttest[sim_node()] = TRUE;

          labC$only_send_one_my_msg[sim_node()] = FALSE;


          labC$radioIn1[sim_node()] = labC$radioOut1[sim_node()] = 0;

          labC$radioFull1[sim_node()] = FALSE;
          labC$My_test_msg_need_retrasmit[sim_node()] = FALSE;
          labC$testframenumber[sim_node()] = labC$testframenumber[sim_node()] - 1;
          sim_log_debug(257U, "lab", "There are %d frames left $!@$!@#!@#\n", labC$testframenumber[sim_node()]);
          sim_log_debug(258U, "lab", "in the first time only starttest equal %d\n", labC$starttest[sim_node()]);
        }
      sim_log_debug(259U, "lab1", "***starttest true begin to start test sim time%s\n", sim_time_string());
    }

  if (labC$EASAP$isOwnSlot(labC$cSlot[sim_node()])) {

      labC$startDelayTimer$postTask();
      sim_log_debug(260U, "lab1", "**************My local time is  %d *************\n", labC$cas1[sim_node()]);
      sim_log_debug(261U, "lab1", "My sim time%s\n", sim_time_string());


      if (TOS_NODE_ID == 6) {
        sim_log_debug(262U, "lab", "is %d my own slot %d ?\n", labC$cSlot[sim_node()], labC$EASAP$isOwnSlot(labC$cSlot[sim_node()]));
        }
    }
}

# 138 "TDMA.nc"
inline static void TDMAC$TDMA$sigNewSlot(tSlot slot){
#line 138
  labC$TDMA$sigNewSlot(slot);
#line 138
}
#line 138
# 58 "SimpleTime.nc"
inline static tos_time_t TDMAC$SimpleTime$addUint32(tos_time_t a, uint32_t x){
#line 58
  unsigned int __nesc_result;
#line 58

#line 58
  __nesc_result = SimpleTimeC$SimpleTime$addUint32(a, x);
#line 58
...
#line 58
#line 151
inline static tos_time_t TDMAC$SimpleTime$get(void ){
#line 151
  unsigned int __nesc_result;
#line 151
...
static inline void TDMAC$Timer$fired(void )
{
  ...
  if (TDMAC$bIntChanged[sim_node()] == TRUE) 
    {


      TDMAC$Timer$startPeriodic(TDMAC$interval[sim_node()]);

      TDMAC$bIntChanged[sim_node()] = FALSE;
      return;
    }

  lTime = TDMAC$SimpleTime$get();



  t = lTime % TDMAC$interval[sim_node()];

  if (t < TDMAC$interval[sim_node()] / 2) {

    TDMAC$Timer$startPeriodic(TDMAC$interval[sim_node()] - t);
    }
  else {
    TDMAC$Timer$startPeriodic(2 * TDMAC$interval[sim_node()] - t);
    }


  lTime = TDMAC$SimpleTime$addUint32(lTime, TDMAC$interval[sim_node()] / 2);



  lTime = lTime / TDMAC$interval[sim_node()];


  currentSlot = lTime % TDMAC$frame[sim_node()];


  TDMAC$TDMA$sigNewSlot(currentSlot);
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x40e53c70){
#line 83
  switch (arg_0x40e53c70) {
#line 83
    case 0U:
#line 83
      labC$QualityTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      labC$FowarderTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      labC$RadioTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      labC$DelayTimer$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      labC$Quality_send_retransmit_csma$fired();
#line 83
      break;
#line 83
    case 5U:
#line 83
      labC$Quality_forward_retransmit_csma$fired();
#line 83
      break;
#line 83
    case 6U:
#line 83
      SimpleTimeC$Timer0$fired();
#line 83
      break;
#line 83
    case 7U:
...
#line 83
    case 8U:
#line 83
      EASAPC$RandTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x40e53c70);
#line 83
      break;
#line 83
    }
...
#line 83
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 78
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x40cbe0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0x40cbe0a0, addr, msg, len);
#line 80
...
inline static bool labC$PacketAcknowledgements$wasAcked(message_t * msg){
#line 85
  unsigned char __nesc_result;
#line 85
...
{
  if (!labC$is_busy[sim_node()]) {
      sim_log_debug(240U, "lab", "relaysend's is busy fault\n");

      return;
    }

  if (labC$PacketAcknowledgements$wasAcked(msg)) {

      { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
        if (msg == labC$radioQueue[sim_node()][labC$radioOut[sim_node()]]) 
          {
            if (++labC$radioOut[sim_node()] >= RADIO_QUEUE_LEN) {
              labC$radioOut[sim_node()] = 0;
              }
#line 935
            if (labC$radioFull[sim_node()]) {
              labC$radioFull[sim_node()] = FALSE;
...
#line 938
        __nesc_atomic_end(__nesc_atomic); }
      labC$is_busy[sim_node()] = FALSE;

      if (labC$radioIn[sim_node()] == labC$radioOut[sim_node()]) {
          sim_log_debug(241U, "lab1", "all of the relay message has been sent\n");
        }
      else {
          labC$RadioTimer$startOneShot(2000 + labC$Random$rand16() % 5000);
        }
...
#line 952
      ...
      labC$PacketAcknowledgements$requestAck(msg);
      if (labC$RelaySend$send(addr, msg, labC$Packet$payloadLength(msg)) == SUCCESS) {
          sim_log_debug(242U, "lab1", "serial message has been successfully send\n");
        }
    }
}

# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  labC$RelaySend$sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMSend$sendDone(m, err);
}

# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
{
  if (!labC$is_busy[sim_node()]) {
      sim_log_debug(165U, "lab", "sth wrong in FinalTestSend\n");
      return;
    }

  if (labC$From_finaltestMymessageSend[sim_node()] && labC$From_sendtest_relay_Task[sim_node()]) {
      sim_log_debug(166U, "lab", "sth wrong in FinalTestSend both From_finaltestMymessageSend&&From_sendtest_relay_Task = true \n");
    }


  if (labC$PacketAcknowledgements$wasAcked(msg) && labC$From_finaltestMymessageSend[sim_node()]) {
      sim_log_debug(167U, "lab1", "successfully send in FinalTestSend From_finaltestMymessageSend \n");
      labC$is_busy[sim_node()] = FALSE;
      labC$My_test_msg_need_retrasmit[sim_node()] = FALSE;
      labC$From_finaltestMymessageSend[sim_node()] = FALSE;

      labC$only_send_one_my_msg[sim_node()] = TRUE;
      return;
    }
  else {
#line 324
    if (!labC$PacketAcknowledgements$wasAcked(msg) && labC$From_finaltestMymessageSend[sim_node()]) {
        ...
        labC$is_busy[sim_node()] = FALSE;
        labC$My_test_msg_need_retrasmit[sim_node()] = TRUE;
        labC$From_finaltestMymessageSend[sim_node()] = FALSE;
        sim_log_debug(168U, "lab1", "From_finaltestMymessageSend RETRANSMIT THIS MSG AT NEXT AVAIABLE SLOT\n");
        return;
      }
    else {
      if (labC$PacketAcknowledgements$wasAcked(msg) && labC$From_sendtest_relay_Task[sim_node()]) {
          sim_log_debug(169U, "lab1", "successfully send in FinalTestSend From_sendtest_relay_Task\n");
          labC$is_busy[sim_node()] = FALSE;
          labC$From_sendtest_relay_Task[sim_node()] = FALSE;

          { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
            if (msg == labC$radioQueue1[sim_node()][labC$radioOut1[sim_node()]]) 
              {
                if (++labC$radioOut1[sim_node()] >= RADIO_QUEUE_LEN) {
                  labC$radioOut1[sim_node()] = 0;
                  }
#line 343
                if (labC$radioFull1[sim_node()]) {
                  labC$radioFull1[sim_node()] = FALSE;
                  }
              }
#line 346
...
#line 348
        if (!labC$PacketAcknowledgements$wasAcked(msg) && labC$From_sendtest_relay_Task[sim_node()]) {
            ...
            sim_log_debug(170U, "lab1", "From_sendtest_relay_TaskRETRANSMIT THIS MSG AT NEXT AVAIABLE SLOT\n");
            labC$is_busy[sim_node()] = FALSE;
            labC$From_sendtest_relay_Task[sim_node()] = FALSE;
          }
        }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  labC$FinalTestSend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMSend$sendDone(m, err);
}

# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void labC$Quality_forward_retransmit_csma$startOneShot(uint32_t dt){
#line 73
...
#line 85
{
  /*labAppC.SendQueue*/QueueC$0$queue_t t = /*labAppC.SendQueue*/QueueC$0$Queue$head();

#line 87
  sim_log_debug(363U, "QueueC", "%s: size is %hhu\n", __FUNCTION__, /*labAppC.SendQueue*/QueueC$0$size[sim_node()]);
  if (!/*labAppC.SendQueue*/QueueC$0$Queue$empty()) {
      /*labAppC.SendQueue*/QueueC$0$head[sim_node()]++;
      if (/*labAppC.SendQueue*/QueueC$0$head[sim_node()] == 100) {
#line 90
        /*labAppC.SendQueue*/QueueC$0$head[sim_node()] = 0;
        }
#line 91
      /*labAppC.SendQueue*/QueueC$0$size[sim_node()]--;
      /*labAppC.SendQueue*/QueueC$0$printQueue();
...
inline static labC$SendQueue$t  labC$SendQueue$dequeue(void ){
#line 81
  struct __nesc_unnamed4289 *__nesc_result;
#line 81

#line 81
  __nesc_result = /*labAppC.SendQueue*/QueueC$0$Queue$dequeue();
#line 81
...
#line 81
# 89 "/opt/tinyos-2.1.2/tos/interfaces/Pool.nc"
inline static error_t labC$MessageSendPool$put(labC$MessageSendPool$t * newVal){
#line 89
  unsigned char __nesc_result;
#line 89

#line 89
  __nesc_result = /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$put(newVal);
#line 89
...
#line 89
# 73 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void labC$Quality_send_retransmit_csma$startOneShot(uint32_t dt){
#line 73
...
#line 464
  sim_log_debug(183U, "lab1", "From_SendQuality_task == %x and From_ForwardQuality_task == %x\n", labC$From_SendQuality_task[sim_node()], labC$From_ForwardQuality_task[sim_node()]);
  if (!labC$is_busy[sim_node()]) {

      return;
    }
  if (labC$From_SendQuality_task[sim_node()] == TRUE && labC$From_ForwardQuality_task[sim_node()] == TRUE) 
    {
      sim_log_debug(184U, "lab", "Wrong Both the From_SendQuality_task == TRUE and From_ForwardQuality_task == TRUE\n");
      return;
    }


  if (labC$From_SendQuality_task[sim_node()] == TRUE && labC$From_ForwardQuality_task[sim_node()] == FALSE) {
      if (labC$PacketAcknowledgements$wasAcked(msg)) {
          sim_log_debug(185U, "lab", "the link quality message have been succesfully sent\n");

          if (labC$MessageSendPool$put(labC$qe[sim_node()]) == SUCCESS) 
            {
              sim_log_debug(186U, "lab1", "SendQuality_task this msg have been succeefully recycled\n");
            }
          else {
              sim_log_debug(187U, "lab", "something is wrong on in the MessageSendPool\n");
            }
          labC$is_busy[sim_node()] = FALSE;
          labC$From_SendQuality_task[sim_node()] = FALSE;
          sim_log_debug(188U, "lab", "**END From_SendQuality_task == %x and From_ForwardQuality_task == %x\n", labC$From_SendQuality_task[sim_node()], labC$From_ForwardQuality_task[sim_node()]);
          return;
        }
      else {
...
#line 503
          b = (uint8_t *)msg->data;
          sim_log_debug(189U, "lab", "\nthe packet need to be retransmitted my mother node is %d\n mymother level is %d", labC$route_info[sim_node()].parent, labC$route_info[sim_node()].parent_level);
          for (i = 0; i < payloadLen; i++) {
              __nesc_hton_uint8(labC$qualitysend_retransmit[sim_node()].data[i].nxdata, b[i]);
              sim_log_debug(190U, "lab", "%x", __nesc_ntoh_uint8(labC$qualitysend_retransmit[sim_node()].data[i].nxdata));
            }
          labC$qualitysendlength[sim_node()] = payloadLen;

          sim_log_debug(191U, "lab", "\nthe saved retrasmited message are there\n");


          timedelay = 2000 + labC$Random$rand16() % 20000;
          sim_log_debug(192U, "lab", "qualityresend time delay is %d\n", timedelay);
          labC$Quality_send_retransmit_csma$startOneShot(timedelay);
          sim_log_debug(193U, "lab", "collision I need rest for a while\n");
    ...
    if (labC$From_ForwardQuality_task[sim_node()] == TRUE && labC$From_SendQuality_task[sim_node()] == FALSE) 
      {
        if (labC$PacketAcknowledgements$wasAcked(msg)) {
            sim_log_debug(194U, "lab", "the Forward quality message have been succesfully sent\n");


            if (labC$MessageSendPool$put(labC$SendQueue$dequeue()) == SUCCESS) 
              {
                sim_log_debug(195U, "lab1", "From_ForwardQuality this msg have been succeefully recycled\n");
              }
            else {
                sim_log_debug(196U, "lab", "something is wrong on in the MessageSendPool\n");
              }

            labC$is_busy[sim_node()] = FALSE;
            labC$From_ForwardQuality_task[sim_node()] = FALSE;

            if (!labC$SendQueue$empty()) {
                labC$FowardQualityTask$postTask();
              }
            sim_log_debug(197U, "lab", "**END From_ForwardQuality == %x and From_ForwardQuality_task == %x\n", labC$From_SendQuality_task[sim_node()], labC$From_ForwardQuality_task[sim_node()]);
            return;
          }
        else {
...
#line 553
            ...
            sim_log_debug(198U, "lab", "the Forward quality need to be retransmitted my mother node is %d mymother level is %d\n \n", labC$route_info[sim_node()].parent, labC$route_info[sim_node()].parent_level);
            for (i = 0; i < payloadLen; i++) {
                __nesc_hton_uint8(labC$qualityforward_retransmit[sim_node()].data[i].nxdata, b[i]);
                sim_log_debug(199U, "lab", "%x", __nesc_ntoh_uint8(labC$qualityforward_retransmit[sim_node()].data[i].nxdata));
              }
            labC$qualityforwardlength[sim_node()] = payloadLen;
            sim_log_debug(200U, "lab", "\nthe saved retrasmited message are there\n");
            timedelay = 2000 + labC$Random$rand16() % 20000;
            sim_log_debug(201U, "lab", "qualityreforward time delay is %d\n", timedelay);
            labC$Quality_forward_retransmit_csma$startOneShot(timedelay);
            sim_log_debug(202U, "lab", "collision I need rest for a while\n");
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(message_t * msg, error_t error){
#line 110
  labC$QualitySend$sendDone(msg, error);
#line 110
}
#line 110
# 65 "/opt/tinyos-2.1.2/tos/system/AMQueueEntryP.nc"
...
#line 65
{
  /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMSend$sendDone(m, err);
}
...
#line 1046
  labC$pocet_odeslanych[sim_node()]++;
  labC$cas2[sim_node()] = labC$SimpleTime$get();
  lastSend = labC$cas2[sim_node()] - labC$cas1[sim_node()];
  if (lastSend > labC$maxSend[sim_node()]) {
      labC$maxSend[sim_node()] = lastSend;
    }

  labC$remSlotsTime[sim_node()] = labC$remSlotsTime[sim_node()] - lastSend;

  if (labC$remSlotsTime[sim_node()] > labC$maxSend[sim_node()]) {
      labC$cas1[sim_node()] = labC$SimpleTime$get();
      return TRUE;
    }
...
#line 1084
{
  if (msg != &labC$beaconMsgBuffer[sim_node()] || !labC$is_busy[sim_node()]) {

      return;
    }
  if (labC$CanSendAnotherData()) {
      labC$sendBeaconTask$postTask();
    }
  labC$is_busy[sim_node()] = FALSE;
}
...
#line 110
  labC$BeaconSend$sendDone(msg, error);
#line 110
}
#line 110
# 841 "LinkEstimatorP.nc"
static inline void LinkEstimatorP$AMSend$sendDone(message_t *msg, error_t error)
#line 841
{
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 110
...
#line 65
{
  /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
#line 577
{
  sim_log_debug(349U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(348U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(345U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(346U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(338U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(328U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 225
  sim_log_debug(335U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 78
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 103
  TossimActiveMessageC$AMPacket$setDestination(amsg, addr);
#line 103
}
#line 103
#line 162
inline static void /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(message_t * amsg, am_id_t t){
#line 162
  TossimActiveMessageC$AMPacket$setType(amsg, t);
#line 162
}
#line 162
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
#line 57
  {
    sim_log_debug(367U, "Init", "LEDS: initialized.\n");
...
#line 561
{
  sim_log_debug(300U, "LI", "Link estimator init\n");
...
#line 364
{
  sim_log_debug(340U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 67
  for (i = 0; i < 100; i++) {
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[sim_node()][i] = &/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[sim_node()][i];
    }
  /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()] = 100;
  /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 67
  for (i = 0; i < 10; i++) {
      /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[sim_node()][i] = &/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[sim_node()][i];
    }
  /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[sim_node()] = 10;
  /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[sim_node()] = 0;
  return SUCCESS;
}
...
#line 62
  __nesc_result = /*labAppC.MessageRecievePool.PoolP*/PoolP$1$Init$init();
#line 62
  __nesc_result = ecombine(__nesc_result, /*labAppC.MessageSendPool.PoolP*/PoolP$0$Init$init());
#line 62
...
#line 1008
  pCurrent->next = (void *)0;
  pCurrent->prev = (void *)0;
  pCurrent->relay = TOS_NODE_ID;
  pCurrent->destination = TOS_NODE_ID;
  for (i = 0; i < UART_QUEUE_LEN; i++) 
    labC$uartQueue[sim_node()][i] = &labC$uartQueueBufs[sim_node()][i];
  labC$uartIn[sim_node()] = labC$uartOut[sim_node()] = 0;
  labC$uartBusy[sim_node()] = FALSE;
  labC$uartFull[sim_node()] = TRUE;

  for (i = 0; i < RADIO_QUEUE_LEN; i++) 
    labC$radioQueue[sim_node()][i] = &labC$radioQueueBufs[sim_node()][i];
  labC$radioIn[sim_node()] = labC$radioOut[sim_node()] = 0;
  labC$radioFull[sim_node()] = TRUE;

  for (i = 0; i < RADIO_QUEUE_LEN; i++) 
    labC$radioQueue1[sim_node()][i] = &labC$radioQueueBufs1[sim_node()][i];
  labC$radioIn1[sim_node()] = labC$radioOut1[sim_node()] = 0;
  labC$radioFull1[sim_node()] = TRUE;

  labC$is_busy[sim_node()] = FALSE;
  labC$quality_time_start[sim_node()] = FALSE;
  labC$seq[sim_node()] = 0;
  labC$is_scheduled[sim_node()] = FALSE;
  labC$is_trigerred[sim_node()] = FALSE;
  labC$My_test_msg_need_retrasmit[sim_node()] = FALSE;
  labC$tdmastarttime[sim_node()] = 98000000;
  labC$firstserialmessage[sim_node()] = TRUE;
  labC$starttest[sim_node()] = FALSE;
  labC$only_send_one_my_msg[sim_node()] = FALSE;
  labC$relayreccount[sim_node()] = 0;
  labC$onlystartonce[sim_node()] = TRUE;
  labC$qualitysendlength[sim_node()] = 0;
  labC$qualityforwardlength[sim_node()] = 0;
  labC$testframenumber[sim_node()] = TEST_FRAME_NUMBER;
}
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t labC$Control$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 104
inline static error_t labC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 1248
{
  labC$AMControl$start();
  labC$Control$start();
  labC$TDMAControl$start();
  switch (TOS_NODE_ID) 
    {
      case 100: labC$is_think_node[sim_node()] = TRUE;
#line 1254
      break;
      default: labC$is_think_node[sim_node()] = FALSE;
    }

  if (labC$is_think_node[sim_node()]) 
    {
      labC$my_level[sim_node()] = 1;
    }
  else 
    {
#line 1263
      labC$my_level[sim_node()] = 100;
    }
#line 1264
  sim_log_debug(278U, "lab", "**************My level is %d *************\n", labC$my_level[sim_node()]);
  labC$init();
  return;
}
...
static inline void TDMAC$Boot$booted(void )
{
  TDMAC$interval[sim_node()] = 1024;
  TDMAC$frame[sim_node()] = 2;
  TDMAC$bIntChanged[sim_node()] = FALSE;
  TDMAC$bRunning[sim_node()] = FALSE;
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void SimpleTimeC$Timer0$startPeriodic(uint32_t dt){
#line 64
...
#line 78
    {
      SimpleTimeC$time[sim_node()] = 0;
    }
#line 80
    __nesc_atomic_end(__nesc_atomic); }
  SimpleTimeC$Timer0$startPeriodic(SimpleTimeC$INTERVAL);
}
...
static inline void EASAPC$Boot$booted(void )
{
  ...
  EASAPC$inf[sim_node()].id = TOS_NODE_ID;
  EASAPC$inf[sim_node()].slots = (void *)0;
  EASAPC$inf[sim_node()].frame = 2;

  memset(& EASAPC$inf[sim_node()].timeStamp, 0, sizeof(tTime ));
  memset(EASAPC$reservedSlot[sim_node()], FALSE, 3000);

  EASAPC$inf[sim_node()].neighbour = FALSE;

  EASAPC$inf[sim_node()].prev = (void *)0;
  EASAPC$inf[sim_node()].next = (void *)0;
...
static error_t EASAPC$EASAPImp$addSlot(tSlot slot, struct Node *pNode)
{
  ...
  if (EASAPC$reservedSlot[sim_node()][slot] == TRUE) {
  ...
  if (pCurrent == (void *)0) 
    ...
    {
      if (EASAPC$EASAPImp$findSlot(slot, pNode) != (void *)0) {
        return EASAP_SLOT_EXISTS;
        }
...
#line 285
  ...
  sim_log_debug(337U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(343U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
static uint8_t labC$Packet$payloadLength(message_t * msg){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
# 79 "/opt/tinyos-2.1.2/tos/system/PoolP.nc"
static uint8_t /*labAppC.MessageSendPool.PoolP*/PoolP$0$Pool$size(void )
#line 79
{
  sim_log_debug(351U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]);
  return /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()];
}
...
#line 88
{
  if (/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]) {
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool_t *rval = /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[sim_node()][/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()]];

#line 91
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[sim_node()][/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()]] = (void *)0;
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]--;
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()]++;
      if (/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()] == 100) {
          /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()] = 0;
        }
      sim_log_debug(352U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]);
      return rval;
    }
  return (void *)0;
}
...
#line 72
  sim_log_debug(358U, "QueueC", "head <-");
  for (i = /*labAppC.SendQueue*/QueueC$0$head[sim_node()]; i < /*labAppC.SendQueue*/QueueC$0$head[sim_node()] + /*labAppC.SendQueue*/QueueC$0$size[sim_node()]; i++) {
      sim_log_debug_clear(359U, "QueueC", "[");
      for (j = 0; j < sizeof(/*labAppC.SendQueue*/QueueC$0$queue_t ); j++) {
          uint8_t v = ((uint8_t *)&/*labAppC.SendQueue*/QueueC$0$queue[sim_node()][i % 100])[j];

#line 77
          sim_log_debug_clear(360U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(361U, "QueueC", "] ");
    }
  sim_log_debug_clear(362U, "QueueC", "<- tail\n");
}
...
#line 215
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(154U, "lab", "%x ", b[i]);
  sim_log_debug_clear(155U, "lab", "\n");
}

# 530 "LinkEstimatorP.nc"
static void LinkEstimatorP$print_packet(message_t *msg, uint8_t len)
#line 530
{
  uint8_t i;
  ...
  b = (uint8_t *)msg->data;
  for (i = 0; i < len; i++) 
    sim_log_debug_clear(297U, "LI", "%x ", b[i]);
  sim_log_debug_clear(298U, "LI", "\n");
}
...
#line 478
{
  ...
  if (LinkEstimatorP$NeighborTable[sim_node()][idx].flags & INIT_ENTRY) {
      sim_log_debug(294U, "LI", "Init entry update\n");
  ...
  sim_log_debug(295U, "LI", "updateNeighborEntryIdx: prevseq %d, curseq %d, gap %d\n", LinkEstimatorP$NeighborTable[sim_node()][idx].lastseq, seq, packetGap);
...
#line 603
    {
      if (LinkEstimatorP$NeighborTable[sim_node()][idx].flags & MATURE_ENTRY) {
          return LinkEstimatorP$computeEETX(LinkEstimatorP$NeighborTable[sim_node()][idx].outquality);
        }
      else 
#line 606
        {
...
static bool EASAPC$EASAP$isOwnSlot(tSlot slot)
{
  struct Slot *pSlot = EASAPC$inf[sim_node()].slots;
...
#line 55
{
  /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setDestination(msg, dest);
  /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$AMPacket$setType(msg, 11);
  return /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$send(msg, len);
}
...
#line 91
{
  ...
  sim_log_debug(318U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 4) {
      ...
      sim_log_debug(319U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(320U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 4;
      ...
      sim_log_debug(321U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x40cbf6a8, message_t * msg, error_t error){
#line 100
  switch (arg_0x40cbf6a8) {
#line 100
    case 0U:
#line 100
      /*labAppC.SendControl.SenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 1U:
#line 100
      /*labAppC.QualitySend.SenderC.AMQueueEntryP*/AMQueueEntryP$1$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 2U:
#line 100
      /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    case 3U:
#line 100
      /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x40cbf6a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 783
{
  ...
  while (pCurrent != (void *)0) {
      if (pCurrent->destination == myaddress) {
          return pCurrent->relay;
        }
      pCurrent = pCurrent->next;
    }
  sim_log_debug(220U, "lab", "cannot find a suitable relay node for this address\n");
  sim_log_debug(221U, "lab", "the address that is myaddress %d\n", myaddress);
  return myaddress;
}
...
#line 55
{
  /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setDestination(msg, dest);
  /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$AMPacket$setType(msg, 12);
  return /*labAppC.RelaySend.SenderC.AMQueueEntryP*/AMQueueEntryP$3$Send$send(msg, len);
}
...
#line 103
{
  if (/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()] >= 100) {
      return FAIL;
    }
  else {
      uint16_t emptyIndex = /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[sim_node()] + /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()];

#line 109
      if (emptyIndex >= 100) {
          emptyIndex -= 100;
        }
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[sim_node()][emptyIndex] = newVal;
      /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]++;
      sim_log_debug(353U, "PoolP", "%s size is %i\n", __FUNCTION__, (int )/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[sim_node()]);
      return SUCCESS;
    }
}
...
#line 101
      sim_log_debug(323U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(324U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(325U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(326U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(344U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(347U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(336U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
...
#line 55
{
  /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setDestination(msg, dest);
  /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$AMPacket$setType(msg, 13);
  return /*labAppC.FinalTestSend.SenderC.AMQueueEntryP*/AMQueueEntryP$2$Send$send(msg, len);
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module labC */
  if (!strcmp(varname, "labC$seq"))
  {
    *addr = (uintptr_t)&labC$seq[__nesc_mote];
    *size = sizeof(labC$seq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$is_scheduled"))
  {
    *addr = (uintptr_t)&labC$is_scheduled[__nesc_mote];
    *size = sizeof(labC$is_scheduled[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$is_trigerred"))
  {
    *addr = (uintptr_t)&labC$is_trigerred[__nesc_mote];
    *size = sizeof(labC$is_trigerred[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$My_test_msg_need_retrasmit"))
  {
    *addr = (uintptr_t)&labC$My_test_msg_need_retrasmit[__nesc_mote];
    *size = sizeof(labC$My_test_msg_need_retrasmit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioQueueBufs1"))
  {
    *addr = (uintptr_t)&labC$radioQueueBufs1[__nesc_mote];
    *size = sizeof(labC$radioQueueBufs1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioQueue1"))
  {
    *addr = (uintptr_t)&labC$radioQueue1[__nesc_mote];
    *size = sizeof(labC$radioQueue1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioIn1"))
  {
    *addr = (uintptr_t)&labC$radioIn1[__nesc_mote];
    *size = sizeof(labC$radioIn1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioOut1"))
  {
    *addr = (uintptr_t)&labC$radioOut1[__nesc_mote];
    *size = sizeof(labC$radioOut1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioFull1"))
  {
    *addr = (uintptr_t)&labC$radioFull1[__nesc_mote];
    *size = sizeof(labC$radioFull1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$cSlot"))
  {
    *addr = (uintptr_t)&labC$cSlot[__nesc_mote];
    *size = sizeof(labC$cSlot[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$pocet_odeslanych"))
  {
    *addr = (uintptr_t)&labC$pocet_odeslanych[__nesc_mote];
    *size = sizeof(labC$pocet_odeslanych[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$remSlotsTime"))
  {
    *addr = (uintptr_t)&labC$remSlotsTime[__nesc_mote];
    *size = sizeof(labC$remSlotsTime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$maxSend"))
  {
    *addr = (uintptr_t)&labC$maxSend[__nesc_mote];
    *size = sizeof(labC$maxSend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$rand_slot"))
  {
    *addr = (uintptr_t)&labC$rand_slot[__nesc_mote];
    *size = sizeof(labC$rand_slot[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$cas1"))
  {
    *addr = (uintptr_t)&labC$cas1[__nesc_mote];
    *size = sizeof(labC$cas1[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$cas2"))
  {
    *addr = (uintptr_t)&labC$cas2[__nesc_mote];
    *size = sizeof(labC$cas2[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$quality_time_start"))
  {
    *addr = (uintptr_t)&labC$quality_time_start[__nesc_mote];
    *size = sizeof(labC$quality_time_start[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$tdmastarttime"))
  {
    *addr = (uintptr_t)&labC$tdmastarttime[__nesc_mote];
    *size = sizeof(labC$tdmastarttime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$firstserialmessage"))
  {
    *addr = (uintptr_t)&labC$firstserialmessage[__nesc_mote];
    *size = sizeof(labC$firstserialmessage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$starttest"))
  {
    *addr = (uintptr_t)&labC$starttest[__nesc_mote];
    *size = sizeof(labC$starttest[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$onlystartonce"))
  {
    *addr = (uintptr_t)&labC$onlystartonce[__nesc_mote];
    *size = sizeof(labC$onlystartonce[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartQueueBufs"))
  {
    *addr = (uintptr_t)&labC$uartQueueBufs[__nesc_mote];
    *size = sizeof(labC$uartQueueBufs[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartQueue"))
  {
    *addr = (uintptr_t)&labC$uartQueue[__nesc_mote];
    *size = sizeof(labC$uartQueue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartIn"))
  {
    *addr = (uintptr_t)&labC$uartIn[__nesc_mote];
    *size = sizeof(labC$uartIn[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartOut"))
  {
    *addr = (uintptr_t)&labC$uartOut[__nesc_mote];
    *size = sizeof(labC$uartOut[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartBusy"))
  {
    *addr = (uintptr_t)&labC$uartBusy[__nesc_mote];
    *size = sizeof(labC$uartBusy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$uartFull"))
  {
    *addr = (uintptr_t)&labC$uartFull[__nesc_mote];
    *size = sizeof(labC$uartFull[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioQueueBufs"))
  {
    *addr = (uintptr_t)&labC$radioQueueBufs[__nesc_mote];
    *size = sizeof(labC$radioQueueBufs[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioQueue"))
  {
    *addr = (uintptr_t)&labC$radioQueue[__nesc_mote];
    *size = sizeof(labC$radioQueue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioIn"))
  {
    *addr = (uintptr_t)&labC$radioIn[__nesc_mote];
    *size = sizeof(labC$radioIn[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioOut"))
  {
    *addr = (uintptr_t)&labC$radioOut[__nesc_mote];
    *size = sizeof(labC$radioOut[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$radioFull"))
  {
    *addr = (uintptr_t)&labC$radioFull[__nesc_mote];
    *size = sizeof(labC$radioFull[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$is_busy"))
  {
    *addr = (uintptr_t)&labC$is_busy[__nesc_mote];
    *size = sizeof(labC$is_busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$testMsgBuffer"))
  {
    *addr = (uintptr_t)&labC$testMsgBuffer[__nesc_mote];
    *size = sizeof(labC$testMsgBuffer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$beaconMsgBuffer"))
  {
    *addr = (uintptr_t)&labC$beaconMsgBuffer[__nesc_mote];
    *size = sizeof(labC$beaconMsgBuffer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qualityMsgBuffer"))
  {
    *addr = (uintptr_t)&labC$qualityMsgBuffer[__nesc_mote];
    *size = sizeof(labC$qualityMsgBuffer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qualitysend_retransmit"))
  {
    *addr = (uintptr_t)&labC$qualitysend_retransmit[__nesc_mote];
    *size = sizeof(labC$qualitysend_retransmit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qualityforward_retransmit"))
  {
    *addr = (uintptr_t)&labC$qualityforward_retransmit[__nesc_mote];
    *size = sizeof(labC$qualityforward_retransmit[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qualitysendlength"))
  {
    *addr = (uintptr_t)&labC$qualitysendlength[__nesc_mote];
    *size = sizeof(labC$qualitysendlength[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qualityforwardlength"))
  {
    *addr = (uintptr_t)&labC$qualityforwardlength[__nesc_mote];
    *size = sizeof(labC$qualityforwardlength[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$relayinfo"))
  {
    *addr = (uintptr_t)&labC$relayinfo[__nesc_mote];
    *size = sizeof(labC$relayinfo[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$relayreccount"))
  {
    *addr = (uintptr_t)&labC$relayreccount[__nesc_mote];
    *size = sizeof(labC$relayreccount[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$beaconMsg"))
  {
    *addr = (uintptr_t)&labC$beaconMsg[__nesc_mote];
    *size = sizeof(labC$beaconMsg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$link_header"))
  {
    *addr = (uintptr_t)&labC$link_header[__nesc_mote];
    *size = sizeof(labC$link_header[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$is_think_node"))
  {
    *addr = (uintptr_t)&labC$is_think_node[__nesc_mote];
    *size = sizeof(labC$is_think_node[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$my_levelchanged"))
  {
    *addr = (uintptr_t)&labC$my_levelchanged[__nesc_mote];
    *size = sizeof(labC$my_levelchanged[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$QualityTimer_is_from_task"))
  {
    *addr = (uintptr_t)&labC$QualityTimer_is_from_task[__nesc_mote];
    *size = sizeof(labC$QualityTimer_is_from_task[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$From_SendQuality_task"))
  {
    *addr = (uintptr_t)&labC$From_SendQuality_task[__nesc_mote];
    *size = sizeof(labC$From_SendQuality_task[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$From_ForwardQuality_task"))
  {
    *addr = (uintptr_t)&labC$From_ForwardQuality_task[__nesc_mote];
    *size = sizeof(labC$From_ForwardQuality_task[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$From_finaltestMymessageSend"))
  {
    *addr = (uintptr_t)&labC$From_finaltestMymessageSend[__nesc_mote];
    *size = sizeof(labC$From_finaltestMymessageSend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$From_sendtest_relay_Task"))
  {
    *addr = (uintptr_t)&labC$From_sendtest_relay_Task[__nesc_mote];
    *size = sizeof(labC$From_sendtest_relay_Task[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$only_send_one_my_msg"))
  {
    *addr = (uintptr_t)&labC$only_send_one_my_msg[__nesc_mote];
    *size = sizeof(labC$only_send_one_my_msg[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$times_left"))
  {
    *addr = (uintptr_t)&labC$times_left[__nesc_mote];
    *size = sizeof(labC$times_left[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$my_level"))
  {
    *addr = (uintptr_t)&labC$my_level[__nesc_mote];
    *size = sizeof(labC$my_level[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$route_info"))
  {
    *addr = (uintptr_t)&labC$route_info[__nesc_mote];
    *size = sizeof(labC$route_info[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$qe"))
  {
    *addr = (uintptr_t)&labC$qe[__nesc_mote];
    *size = sizeof(labC$qe[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$newlength"))
  {
    *addr = (uintptr_t)&labC$newlength[__nesc_mote];
    *size = sizeof(labC$newlength[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "labC$testframenumber"))
  {
    *addr = (uintptr_t)&labC$testframenumber[__nesc_mote];
    *size = sizeof(labC$testframenumber[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "LinkEstimatorP$prevSentlinkqualityIdx"))
  {
    *addr = (uintptr_t)&LinkEstimatorP$prevSentlinkqualityIdx[__nesc_mote];
    *size = sizeof(LinkEstimatorP$prevSentlinkqualityIdx[__nesc_mote]);
    return 0;
  }
  ...
  /* Module PoolP$0 */
  if (!strcmp(varname, "/*labAppC.MessageSendPool.PoolP*/PoolP$0$free"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[__nesc_mote];
    *size = sizeof(/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageSendPool.PoolP*/PoolP$0$index"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[__nesc_mote];
    *size = sizeof(/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageSendPool.PoolP*/PoolP$0$queue"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[__nesc_mote];
    *size = sizeof(/*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[__nesc_mote];
    *size = sizeof(/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[__nesc_mote]);
    return 0;
  }

  /* Module PoolP$1 */
  if (!strcmp(varname, "/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[__nesc_mote];
    *size = sizeof(/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[__nesc_mote];
    *size = sizeof(/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[__nesc_mote];
    *size = sizeof(/*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool"))
  {
    *addr = (uintptr_t)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[__nesc_mote];
    *size = sizeof(/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[__nesc_mote]);
    return 0;
  }

  /* Module QueueC$0 */
  if (!strcmp(varname, "/*labAppC.SendQueue*/QueueC$0$queue"))
  {
    *addr = (uintptr_t)&/*labAppC.SendQueue*/QueueC$0$queue[__nesc_mote];
    *size = sizeof(/*labAppC.SendQueue*/QueueC$0$queue[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.SendQueue*/QueueC$0$head"))
  {
    *addr = (uintptr_t)&/*labAppC.SendQueue*/QueueC$0$head[__nesc_mote];
    *size = sizeof(/*labAppC.SendQueue*/QueueC$0$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.SendQueue*/QueueC$0$tail"))
  {
    *addr = (uintptr_t)&/*labAppC.SendQueue*/QueueC$0$tail[__nesc_mote];
    *size = sizeof(/*labAppC.SendQueue*/QueueC$0$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*labAppC.SendQueue*/QueueC$0$size"))
  {
    *addr = (uintptr_t)&/*labAppC.SendQueue*/QueueC$0$size[__nesc_mote];
    *size = sizeof(/*labAppC.SendQueue*/QueueC$0$size[__nesc_mote]);
    return 0;
  }
  ...
  /* Module TDMAC */
  if (!strcmp(varname, "TDMAC$interval"))
  {
    *addr = (uintptr_t)&TDMAC$interval[__nesc_mote];
    *size = sizeof(TDMAC$interval[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TDMAC$frame"))
  {
    *addr = (uintptr_t)&TDMAC$frame[__nesc_mote];
    *size = sizeof(TDMAC$frame[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TDMAC$bIntChanged"))
  {
    *addr = (uintptr_t)&TDMAC$bIntChanged[__nesc_mote];
    *size = sizeof(TDMAC$bIntChanged[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "TDMAC$bRunning"))
  {
    *addr = (uintptr_t)&TDMAC$bRunning[__nesc_mote];
    *size = sizeof(TDMAC$bRunning[__nesc_mote]);
    return 0;
  }

  /* Module SimpleTimeC */
  if (!strcmp(varname, "SimpleTimeC$time"))
  {
    *addr = (uintptr_t)&SimpleTimeC$time[__nesc_mote];
    *size = sizeof(SimpleTimeC$time[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTimeC$tdmastarttime"))
  {
    *addr = (uintptr_t)&SimpleTimeC$tdmastarttime[__nesc_mote];
    *size = sizeof(SimpleTimeC$tdmastarttime[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SimpleTimeC$settdma"))
  {
    *addr = (uintptr_t)&SimpleTimeC$settdma[__nesc_mote];
    *size = sizeof(SimpleTimeC$settdma[__nesc_mote]);
    return 0;
  }
  ...
  /* Module EASAPC */
  if (!strcmp(varname, "EASAPC$inf"))
  {
    *addr = (uintptr_t)&EASAPC$inf[__nesc_mote];
    *size = sizeof(EASAPC$inf[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "EASAPC$reservedSlot"))
  {
    *addr = (uintptr_t)&EASAPC$reservedSlot[__nesc_mote];
    *size = sizeof(EASAPC$reservedSlot[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module labC */
  labC$seq[__nesc_mote] = 0;
  labC$is_scheduled[__nesc_mote] = FALSE;
  labC$is_trigerred[__nesc_mote] = FALSE;
  labC$My_test_msg_need_retrasmit[__nesc_mote] = FALSE;
  memset((void *)&labC$radioQueueBufs1[__nesc_mote], 0, sizeof labC$radioQueueBufs1[__nesc_mote]);
  memset((void *)&labC$radioQueue1[__nesc_mote], 0, sizeof labC$radioQueue1[__nesc_mote]);
  memset((void *)&labC$radioIn1[__nesc_mote], 0, sizeof labC$radioIn1[__nesc_mote]);
  memset((void *)&labC$radioOut1[__nesc_mote], 0, sizeof labC$radioOut1[__nesc_mote]);
  memset((void *)&labC$radioFull1[__nesc_mote], 0, sizeof labC$radioFull1[__nesc_mote]);
  memset((void *)&labC$cSlot[__nesc_mote], 0, sizeof labC$cSlot[__nesc_mote]);
  memset((void *)&labC$pocet_odeslanych[__nesc_mote], 0, sizeof labC$pocet_odeslanych[__nesc_mote]);
  memset((void *)&labC$remSlotsTime[__nesc_mote], 0, sizeof labC$remSlotsTime[__nesc_mote]);
  labC$maxSend[__nesc_mote] = 0;
  labC$rand_slot[__nesc_mote] = 0;
  memset((void *)&labC$cas1[__nesc_mote], 0, sizeof labC$cas1[__nesc_mote]);
  memset((void *)&labC$cas2[__nesc_mote], 0, sizeof labC$cas2[__nesc_mote]);
  labC$quality_time_start[__nesc_mote] = FALSE;
  labC$tdmastarttime[__nesc_mote] = 98000000;
  labC$firstserialmessage[__nesc_mote] = TRUE;
  labC$starttest[__nesc_mote] = FALSE;
  labC$onlystartonce[__nesc_mote] = TRUE;
  memset((void *)&labC$uartQueueBufs[__nesc_mote], 0, sizeof labC$uartQueueBufs[__nesc_mote]);
  memset((void *)&labC$uartQueue[__nesc_mote], 0, sizeof labC$uartQueue[__nesc_mote]);
  memset((void *)&labC$uartIn[__nesc_mote], 0, sizeof labC$uartIn[__nesc_mote]);
  memset((void *)&labC$uartOut[__nesc_mote], 0, sizeof labC$uartOut[__nesc_mote]);
  memset((void *)&labC$uartBusy[__nesc_mote], 0, sizeof labC$uartBusy[__nesc_mote]);
  memset((void *)&labC$uartFull[__nesc_mote], 0, sizeof labC$uartFull[__nesc_mote]);
  memset((void *)&labC$radioQueueBufs[__nesc_mote], 0, sizeof labC$radioQueueBufs[__nesc_mote]);
  memset((void *)&labC$radioQueue[__nesc_mote], 0, sizeof labC$radioQueue[__nesc_mote]);
  memset((void *)&labC$radioIn[__nesc_mote], 0, sizeof labC$radioIn[__nesc_mote]);
  memset((void *)&labC$radioOut[__nesc_mote], 0, sizeof labC$radioOut[__nesc_mote]);
  memset((void *)&labC$radioFull[__nesc_mote], 0, sizeof labC$radioFull[__nesc_mote]);
  labC$is_busy[__nesc_mote] = FALSE;
  memset((void *)&labC$testMsgBuffer[__nesc_mote], 0, sizeof labC$testMsgBuffer[__nesc_mote]);
  memset((void *)&labC$beaconMsgBuffer[__nesc_mote], 0, sizeof labC$beaconMsgBuffer[__nesc_mote]);
  memset((void *)&labC$qualityMsgBuffer[__nesc_mote], 0, sizeof labC$qualityMsgBuffer[__nesc_mote]);
  memset((void *)&labC$qualitysend_retransmit[__nesc_mote], 0, sizeof labC$qualitysend_retransmit[__nesc_mote]);
  memset((void *)&labC$qualityforward_retransmit[__nesc_mote], 0, sizeof labC$qualityforward_retransmit[__nesc_mote]);
  labC$qualitysendlength[__nesc_mote] = 0;
  labC$qualityforwardlength[__nesc_mote] = 0;
  memset((void *)&labC$relayinfo[__nesc_mote], 0, sizeof labC$relayinfo[__nesc_mote]);
  labC$relayreccount[__nesc_mote] = 0;
  memset((void *)&labC$beaconMsg[__nesc_mote], 0, sizeof labC$beaconMsg[__nesc_mote]);
  memset((void *)&labC$link_header[__nesc_mote], 0, sizeof labC$link_header[__nesc_mote]);
  labC$is_think_node[__nesc_mote] = FALSE;
  labC$my_levelchanged[__nesc_mote] = FALSE;
  labC$QualityTimer_is_from_task[__nesc_mote] = FALSE;
  labC$From_SendQuality_task[__nesc_mote] = FALSE;
  labC$From_ForwardQuality_task[__nesc_mote] = FALSE;
  labC$From_finaltestMymessageSend[__nesc_mote] = FALSE;
  labC$From_sendtest_relay_Task[__nesc_mote] = FALSE;
  labC$only_send_one_my_msg[__nesc_mote] = FALSE;
  labC$times_left[__nesc_mote] = 0;
  labC$my_level[__nesc_mote] = 10;
  memset((void *)&labC$route_info[__nesc_mote], 0, sizeof labC$route_info[__nesc_mote]);
  memset((void *)&labC$qe[__nesc_mote], 0, sizeof labC$qe[__nesc_mote]);
  labC$newlength[__nesc_mote] = 0;
  labC$testframenumber[__nesc_mote] = TEST_FRAME_NUMBER;
  ...
  LinkEstimatorP$prevSentlinkqualityIdx[__nesc_mote] = 0;
  ...
  /* Module PoolP$0 */
  memset((void *)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$free[__nesc_mote], 0, sizeof /*labAppC.MessageSendPool.PoolP*/PoolP$0$free[__nesc_mote]);
  memset((void *)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$index[__nesc_mote], 0, sizeof /*labAppC.MessageSendPool.PoolP*/PoolP$0$index[__nesc_mote]);
  memset((void *)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[__nesc_mote], 0, sizeof /*labAppC.MessageSendPool.PoolP*/PoolP$0$queue[__nesc_mote]);
  memset((void *)&/*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[__nesc_mote], 0, sizeof /*labAppC.MessageSendPool.PoolP*/PoolP$0$pool[__nesc_mote]);

  /* Module PoolP$1 */
  memset((void *)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[__nesc_mote], 0, sizeof /*labAppC.MessageRecievePool.PoolP*/PoolP$1$free[__nesc_mote]);
  memset((void *)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[__nesc_mote], 0, sizeof /*labAppC.MessageRecievePool.PoolP*/PoolP$1$index[__nesc_mote]);
  memset((void *)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[__nesc_mote], 0, sizeof /*labAppC.MessageRecievePool.PoolP*/PoolP$1$queue[__nesc_mote]);
  memset((void *)&/*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[__nesc_mote], 0, sizeof /*labAppC.MessageRecievePool.PoolP*/PoolP$1$pool[__nesc_mote]);

  /* Module QueueC$0 */
  memset((void *)&/*labAppC.SendQueue*/QueueC$0$queue[__nesc_mote], 0, sizeof /*labAppC.SendQueue*/QueueC$0$queue[__nesc_mote]);
  /*labAppC.SendQueue*/QueueC$0$head[__nesc_mote] = 0;
  /*labAppC.SendQueue*/QueueC$0$tail[__nesc_mote] = 0;
  /*labAppC.SendQueue*/QueueC$0$size[__nesc_mote] = 0;

  /* Module AMQueueEntryP$3 */

  /* Module TDMAC */
  memset((void *)&TDMAC$interval[__nesc_mote], 0, sizeof TDMAC$interval[__nesc_mote]);
  memset((void *)&TDMAC$frame[__nesc_mote], 0, sizeof TDMAC$frame[__nesc_mote]);
  memset((void *)&TDMAC$bIntChanged[__nesc_mote], 0, sizeof TDMAC$bIntChanged[__nesc_mote]);
  memset((void *)&TDMAC$bRunning[__nesc_mote], 0, sizeof TDMAC$bRunning[__nesc_mote]);

  /* Module SimpleTimeC */
  memset((void *)&SimpleTimeC$time[__nesc_mote], 0, sizeof SimpleTimeC$time[__nesc_mote]);
  SimpleTimeC$tdmastarttime[__nesc_mote] = 0xffffffff;
  SimpleTimeC$settdma[__nesc_mote] = FALSE;

  /* Module LedsP */

  /* Module EASAPC */
  memset((void *)&EASAPC$inf[__nesc_mote], 0, sizeof EASAPC$inf[__nesc_mote]);
  memset((void *)&EASAPC$reservedSlot[__nesc_mote], 0, sizeof EASAPC$reservedSlot[__nesc_mote]);
